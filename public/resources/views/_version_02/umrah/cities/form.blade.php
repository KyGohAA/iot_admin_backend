		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group{{ $errors->has('country_id') ? ' has-error' : '' }}">
					...
					<div class="col-md-8">
						{!! Form::select('country_id', App\Country::combobox(), null, ['class'=>'form-control','autofocus','required','onchange'=>'init_state_selectbox(this)']) !!}
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group{{ $errors->has('state_id') ? ' has-error' : '' }}">
					...
					<div class="col-md-8">
						{!! Form::select('state_id', App\State::combobox($model->country_id), null, ['class'=>'form-control','required']) !!}
	...
	<div class="box-footer">
		<div class="row">
			<div class="col-md-offset-2 col-md-10">
				...
				<a href="{{action('CitiesController@getIndex')}}" class="btn btn-danger"><i class="fa fa-ban fa-fw"></i>{{App\Language::trans('Close')}}</a>
			</div>
		</div>
	</div>
</div>
