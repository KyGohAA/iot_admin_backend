        ...
        <nav class="hk-nav hk-nav-dark">
            ...
            <div class="nicescroll-bar">
                <div class="navbar-nav-wrap">
                    ...
                    @endif
                        <li class="nav-item">
                            <a class="nav-link" href="{{action('DashboardsController@getUserProfile')}}">
            ...
            @if(Auth::User()->is_admin)
                        ...
                        <li class="nav-item">
                            ...
                            <ul id="income_expenses_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{action('IETransactionsController@getIndex', 'index')}}">{{App\Language::trans('Transaction')}}</a>
                                        </li>                                   
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <ul id="oc_product_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{action('OCProductsController@getIndex', 'is_verified')}}">{{App\Language::trans('Active Product')}}</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{action('OCProductsController@getIndex', 'is_removed')}}">{{App\Language::trans('Removed Product')}}</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{action('OCProductsController@getNew')}}">{{App\Language::trans('Mobile Page')}}</a>
                                        </li>                                       
                                    </ul>
                                </li>
                            </ul>
                ...
                @if(App\Company::is_allow_to_access_module(App\Setting::LABEL_MODULE_ACCOUNTING))
                    ...
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{action('TicketsController@getIndex')}}">
                                <span class="feather-icon"><i data-feather="log-in"></i></span>
                        ...
                        <li class="nav-item">
                            ...
                            <ul id="product_setting_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                         <li class="nav-item">
                                             <a class="nav-link" href="{{action('ProductsController@getIndex')}}">{{App\Language::trans('Product')}}</a> 
                                         </li> 
                                         <li class="nav-item">
                                             <a class="nav-link" href="{{action('ProductCategoriesController@getIndex')}}">{{App\Language::trans('Product Category')}}</a> 
                                         </li>                                     
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{action('MembershipsController@getIndex')}}">
                                <span class="feather-icon"><i data-feather="user"></i></span>
                ...
                @if(App\Company::is_allow_to_access_module(App\Setting::LABEL_MODULE_POWER_MANAGEMENT))
                    ...
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            <a class="nav-link" href="{{action('UMeterRefundsController@getIndex')}}">
                                <span class="feather-icon"><i data-feather="pie-chart"></i></span>
                        ...
                        <li class="nav-item">
                            ...
                            <ul id="developers_drp" class="nav flex-column collapse collapse-level-1">
                                ...
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{action('UMeterPaymentReceivedDebugsController@getDebugIndex')}}">{{App\Language::trans('Payment Check')}}</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
