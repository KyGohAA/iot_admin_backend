      ...
      <div class="row">
        <div class="col s12">    
          ...
          <div class="shipping-info-wrap ck-box">
            <div class="row">
              <div class="input-field col s12 m12 l12 ">
                <div class="payment-method-text">
                  <i class="fab fa-wpforms"></i> Income Summary
                </div>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="input-field col s12 m12 l12 ">
                   <div class="new-shipping-address">Transaction Slip <small>[optional]</small></div>
                {!!Form::file("receipt_filename", array("id"=>"receipt_filename","class"=>"validate"))!!}  
              </div>
            </div>
            <hr>
        ...
        <div class="row">
          ...
          <div class="input-field col s6 m12 l6 ">
            ...
            <div class="row">
              <div class="input-field col s12 m12 l12 ">
                {!! Form::text('description', '', ['id' => 'description', 'class'=>'validate','required']) !!}
