			...
			<div class="card card-sm">
				<div class="card-body">
					...
					<div class="d-flex align-items-center justify-content-between position-relative">
						<div>
							<span class="d-block display-6 font-weight-400 text-dark">{{isset($last_update_at) ? $last_update_at : '-'}}</span>
						</div>
						<div class="position-absolute r-0">
							<span id="pie_chart_1" class="d-flex easy-pie-chart" data-percent="86">
								<span class="percent head-font">Replacement</span>
							</span>
						</div>
					</div>
				</div>
			...
			<div class="card card-sm">
				<div class="card-body">
					...
					<div class="d-flex align-items-end justify-content-between">
						...
						<div>
							<span class="text-success font-12 font-weight-600">{{App\MeterPaymentReceived::get_minimum_credit_user()}}</span>
						</div>
					</div>
				</div>
			</div>
...
<div class="hk-row">
		<div class="col-lg-3 col-sm-6">
			<div class="card card-sm">
				<div class="card-body">
					<span class="d-block font-11 font-weight-500 text-dark text-uppercase mb-10 last_update_at">{{App\Language::trans('Total Member')}}</span>
					<div class="d-flex align-items-center justify-content-between position-relative">
						<div>
							<span class="d-block display-6 font-weight-400 text-dark"></span>
						</div>
						<div class="position-absolute r-0">
								<span class="text-success font-12 font-weight-600">{{App\Customer::get_today_new_record() > 0 ? '+' : ''}} {{App\Customer::get_today_new_record()}}</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="card card-sm">
				<div class="card-body">
					...
					<div class="d-flex align-items-center justify-content-between position-relative">
						<div>
							<span class="d-block">
								<span class="display-6 font-weight-400 text-dark"><span class="counter-anim"></span></span>
							</span>
						</div>
						<div class="position-absolute r-0">
	
								<span class="text-success font-12 font-weight-600">{{App\MembershipModel\ARInvoice::get_today_new_record() > 0 ? '+' : ''}} {{App\MembershipModel\ARInvoice::get_today_new_record()}}</span>
			...
			<div class="card card-sm">
				<div class="card-body">
					...
					<div class="d-flex align-items-end justify-content-between">
						<div>
							<span class="d-block">
								<span class="display-6 font-weight-400 text-dark"></span>
								<small></small>
							</span>
						</div>
						<div>
							<span class="text-success font-12 font-weight-600">{{App\MembershipModel\ARPaymentReceived::get_today_new_record() > 0 ? '+' : ''}} {{App\MembershipModel\ARPaymentReceived::get_today_new_record()}}</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="card card-sm">
				<div class="card-body">
					...
					<div class="d-flex align-items-end justify-content-between">
						...
						<div>
							<span class="text-success font-12 font-weight-600">{{App\Ticket::get_today_new_record() > 0 ? '+' : ''}} {{App\Ticket::get_today_new_record()}}</span>
						</div>
					</div>
				</div>
			</div>
