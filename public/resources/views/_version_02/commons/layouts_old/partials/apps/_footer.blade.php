<div id="footer____cancel_css" style="background-color:#59abf7;z-index: auto; position: fixed; bottom: 0px; left: 0px; width:100%;">
    <div class="nav-tabs-custom" style="margin:0;">
        <ul class="nav nav-tabs">
            <li class="active" style="margin:0;width:33%;text-align:center;box-sizing:border-box"><a href="#tab_1" data-toggle="tab"><i class="material-icons">account_balance_wallet</i><br>Payment</a></li>
            <li style="margin:0;width:33%;text-align:center;box-sizing:border-box"><a href="#tab_2" data-toggle="tab"><i class="material-icons">event</i><br>History</a></li>
            <li style="margin:0;width:33%;text-align:center;box-sizing:border-box"><a href="#tab_3" data-toggle="tab"><i class="material-icons"></i><br>Help</a></li>
        </ul>
    </div> 
</div>
