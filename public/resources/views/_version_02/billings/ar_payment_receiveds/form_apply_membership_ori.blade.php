                                    ...
                                    @foreach($membership->items as $member)
                                        <tr id={{$member['id_house_member']}}>
                                            ...
                                            <td>
                                                    ...
                                                    <label onclick="create_or_update_member_modal({{$member['id_house_member']}});" type="button" class="button default">
                                                        <span class="feather-icon"><i data-feather="edit"></i></span>
                                                    </label>
                                         
                                            </td>
                                            <td>
                                                <button type="button" class="close" aria-label="Edit" onclick="remove_row_membership_application({{$member['id_house_member']}});">
        ...
        <div class="row">
            ...
            <div class="col-xl-7 mb-20">
                <form class="list" id="my-form" action="{{action('AppAccountingDashboardsController@getPayment')}}" method="get">
                    ...
                    <button href="{{action('AppAccountingDashboardsController@getPayment')}}" target='_blank' class="btn btn-primary btn-block" type="submit" id="btn_payment">Pay {{$model['amount']}}</button>
    ...
    <section>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 mb-20">
                ...
                <a class="btn btn-primary btn-block mb-10" target="_blank" href="{{action('ARPaymentReceivedsController@getPrint', [53])}}">Generate Receipt</a>
