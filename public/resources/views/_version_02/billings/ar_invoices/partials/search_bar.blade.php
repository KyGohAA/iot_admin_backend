			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group{{ $errors->has('ar_invoice_id') ? ' has-error' : '' }}">
						{!! Form::label('ar_invoice_id', App\Language::trans('Document'), ['class'=>'control-label col-md-6']) !!}
						<div class="col-md-6">
							{!! Form::select('ar_invoice_id', App\MembershipModel\ARInvoice::combobox(), null, ['class'=>'form-control']) !!}
		                    {!!$errors->first('ar_invoice_id', '<label for="ar_invoice_id" class="help-block error">:message</label>')!!}
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group{{ $errors->has('sort_by') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							{!! Form::select('sort_by', App\MembershipModel\ARInvoice::sort_by_combobox(), null, ['class'=>'form-control']) !!}
