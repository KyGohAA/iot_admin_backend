						...
						<tbody>
							@foreach($model->items as $row)
								<tr>
									<td>{{$i}}</td>
									<td>
										{!!Form::select('products['.$i.'][product_id]', App\Product::combobox(), $row->product_id, ['class'=>'form-control','onchange'=>'init_product_info(this, "sales")'])!!}
									</td>
									<td>
							...
							<tr>
								<td>{{$i}}</td>
								<td>
									{!!Form::select('products['.$i.'][product_id]', App\Product::combobox(), null, ['class'=>'form-control','onchange'=>'init_product_info(this, "sales")'])!!}
								</td>
								<td>
