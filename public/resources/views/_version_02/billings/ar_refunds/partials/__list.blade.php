		...
		<div class="row">
			<div class="col-md-12">
				<div class="table-responsive">
					<table id="payment_received_table" class="table table-bordered table-hover" style="min-width: 1000px;">
						<thead>
							<tr>
						...
						<tfoot>
							<tr>
								...
								<td name="total_applied_amount" id="total_applied_amount"  class="text-right">{{$model->getDouble(0)}}</td>
							</tr>
						</tfoot>
					</table>
				</div>
