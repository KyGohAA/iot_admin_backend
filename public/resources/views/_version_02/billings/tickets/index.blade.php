                    ...
                    <tbody>
						...
						<tr>
							...
							<td class="text-center">
								<!-- <a onclick="return confirm(confirmMsg)" class="loading-label" href="{{action('TicketsController@getEdit', [$row->id])}}">{{App\Language::trans('Edit')}}</a> | 
								<a href="{{action('TicketsController@getView', [$row->id])}}">{{App\Language::trans('View')}}</a> |  -->
								<a class="loading-label" href="{{action('TicketsController@getSolve', [$row->id])}}">{{App\Language::trans('Feedback')}}</a> | 
								<a onclick="return confirm(confirmMsg)" class="loading-label" href="{{action('TicketsController@getDelete', [$row->id])}}">{{App\Language::trans('Del')}}</a>
							</td>
						</tr>
						@endforeach
