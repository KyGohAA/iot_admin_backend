...
<div class="card-columns card-column-1">
	<div class="card card-profile-feed mb-0 rounded-bottom-0">
		<div class="card-header card-header-action">
			<div class="media align-items-center">
				...
				<div class="media-body">
					<div class="text-capitalize font-weight-500 text-dark">{{$model->customer_name}}</div>
		...
		<div class="card-body">
			<p class="card-text mb-30">{!!$model->complaint!!}</p>
			...
			<div class="media">
				...
				<div class="media-body">
					...
					<div class="d-flex mt-10">
						<span class="font-14 text-light mr-15">{{$row->settled_at}}</span>
					</div>
				</div>
			</div>
		</div>
