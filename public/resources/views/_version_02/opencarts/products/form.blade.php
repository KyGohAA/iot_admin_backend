...
<section class="hk-sec-wrapper">
    <h5 class="hk-sec-title">{{App\Language::trans('Product Photos')}}</h5>
    <hr>
    <div class="row">
        <div class="col-sm">
            <div class="form-row">
                <div class="col-md-12 mb-15">
                    <label>{{App\Language::trans('Cover Photo')}}</label> 
                </div>

                <div class="col-md-12 mb-15">
                   @if($model->image)
	               <div class="col-md-4">
	                  <img class="img-fluid img-thumbnail img-responsive" width="150" height ="150" src="{{asset($model->image)}}">
                ...
                <div class="col-md-12 mb-15">
                    <label>{{App\Language::trans('Product Photo Set')}}</label> 
                </div>
                     ...
                     @if(count($product_image_listing) > 0)
			               ...
			               <div class="col-md-2 mb-15">
			                  <img class="img-fluid img-thumbnail img-responsive" width="150" height ="150" src="{{asset($row->image)}}">            
			                  <!--    <div class="text-center checkbox-custom checkbox-danger mb5">
			                     {!!Form::checkbox("company_logo_del", $model->id_company, false, array("id"=>"company_logo_del"))!!}
			                     <label for="company_logo_del">{{App\Language::trans('Remove file')}}</label>
			                     </div> -->
...
<section class="hk-sec-wrapper">
	...
	<h5 class="hk-sec-title">{{App\Language::trans('Product Information')}}</h5>
	 <!-- Nav tabs -->
 ...
 <section class="hk-sec-wrapper">
    <h5 class="hk-sec-title">{{App\Language::trans('Other Information')}}</h5>
    <hr>
	        <div class="row">
	 		<div class="col-md-12">
	 			<h6 class="page-header">{{App\Language::trans('Price and Cost')}}</h6>
	 			<hr>
	 		</div>
	       ...
	       <div class="row">
    		...
    		<div class="row">
	    		 ...
	    		 <div class="col-md-12">
	    				<br>
	    	 			<h6 class="page-header">{{App\Language::trans('Stock')}}</h6>
	    	 			<hr>
	    	 	</div>
	       ...
	       <div class="row">
	       		<div class="col-md-12">
	       			<br>
    	 			<h6 class="page-header">{{App\Language::trans('Product Attributes')}}</h6>
    	 			<hr>
    	 		</div>
		       ...
		       <div class="col-md-6">
		        ...
		        <div class="col-md-6">
		        	<div class="form-group{{ $errors->has('lenght_class_id') ? ' has-error' : '' }}">
						{!! Form::label('lenght_class_id', App\Language::trans('Length Class'), ['class'=>'control-label col-md-4']) !!}
						<div class="col-md-8">
			...
			<div class="row">
				<div class="col-md-12">
					{!! Form::label('dimension', App\Language::trans('Dimension (L x W x H)'), ['class'=>'control-label col-md-12']) !!}
     		  	</div>
     		  	<div class="col-md-12">
	       ...
	       <div class="row">
	       		<div class="col-md-12">
	       		<br><br>
    	 			<h6 class="page-header">{{App\Language::trans('Other Attributes')}}</h6>
    	 			<hr>
    	 		</div>
...
<section class="hk-sec-wrapper">
	<div id='footer'  class="box-footer">
		<div class="row">
			...
			<a href="{{action('OCProductsController@getDashboard')}}" class="btn btn-danger btn-wth-icon icon-wthot-bg btn-lg pull-right"><span class="icon-label"><i class="fa fa-close"></i> </span><span class="btn-text">{{App\Language::trans('Close')}}</span></a>
				<button  id="submit_button" class="btn btn-success btn-wth-icon icon-wthot-bg btn-lg pull-right"><span class="icon-label"><i class="fa fa-save"></i> </span><span class="btn-text">{{App\Language::trans('Save')}}</span></button>
