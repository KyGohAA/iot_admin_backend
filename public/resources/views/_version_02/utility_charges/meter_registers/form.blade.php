...
<section class="hk-sec-wrapper">
    <h5 class="hk-sec-title">{{App\Language::trans('Detail')}}</h5><hr>
   ...
   <div class="row">
					 ...
					 <div class="row">	
					 	<div class="col-md-3">
						    <div class="custom-control custom-radio">
						        ...
						        <label class="custom-control-label" for="status_on">{{App\Language::trans('Enabled')}}</label>
						    </div>
						</div>
						<div class="col-md-3">
						    <div class="custom-control custom-radio">
     ...
     <div class="row">
		<div class="col-md-6">
			<div class="form-group{{ $errors->has('is_power_supply_on') ? ' has-error' : '' }}">
				{!! Form::label('is_power_supply_on', App\Language::trans('Is Power Supply On'), ['class'=>'control-label col-md-12']) !!}
				<div class="col-md-12">
					 <div class="row">	
					 	<div class="col-md-3">
						    <div class="custom-control custom-radio">
						        <input type="radio" id="is_power_supply_on_on" name="is_power_supply_on" checked class="custom-control-input">
						        <label class="custom-control-label" for="is_power_supply_on_on">{{App\Language::trans('Yes')}}</label>
						    </div>
						</div>
						<div class="col-md-3">
						    <div class="custom-control custom-radio">
						        <input type="radio" id="is_power_supply_on_off" name="is_power_supply_on"  class="custom-control-input">
						        <label class="custom-control-label" for="is_power_supply_on_off">{{App\Language::trans('No')}}</label>
						    </div>
						</div>
					 </div>
					 {!!$errors->first('is_power_supply_on', '<label for="is_power_supply_on" class="help-block error">:message</label>')!!}
				</div>
			</div>
		</div>	
	</div>
    ...
    <div class="row">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group{{ $errors->has('meter_class_id') ? ' has-error' : '' }}">
					...
					<div class="col-md-8">
						{!! Form::select('meter_class_id', App\PowerMeterModel\MeterClass::combobox(), null, ['class'=>'form-control','required']) !!}
		...
		<h5 class="hk-sec-title">{{App\Language::trans('Price Information')}}</h5><hr>
		<div class="row">
			<div class="col-md-12">
		...
		<h5 class="hk-sec-title">{{App\Language::trans('Billing Information')}}</h5><hr>
		<div class="row">
			<div class="col-md-6">
