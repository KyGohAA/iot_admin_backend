		...
		<div class="row">
			...
			<div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                ...
                <!-- <div class="form-group{{ $errors->has('payment_from_account_id') ? ' has-error' : '' }}">
					...
					<div class="col-md-8">
						{!! Form::select('payment_from_account_id', App\Setting::bank_or_cash_combobox(), null, ['class'=>'form-control','autofocus','required','onchange'=>'init_customer_info(this)']) !!}
...
<div>
	@include('_version_02.commons.ar_refunds.partials.__list')
</div>
