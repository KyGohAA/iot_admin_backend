					...
					<tbody>
						@foreach($listing as $index => $row)
							<tr>
								...
								<td class="text-center">{{$row->current_date}}</td>
								<td class="text-center">{{$row->time_started}}</td>
								<td class="text-center">{{$row->time_ended}}</td>
								<td class="text-center">{{$row->last_meter_reading}}</td>
								<td class="text-center">{{$row->current_meter_reading}}</td>
								<td class="text-center">{{$row->current_usage}}</td>
							</tr>
							@php  $total += $row->current_usage; @endphp
						@endforeach
					</tbody>
					<tfoot>
						<tr>
