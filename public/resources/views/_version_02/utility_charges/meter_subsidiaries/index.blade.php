                    ...
                    <tbody>
						...
						<tr>
							...
							<td class="text-center">
								<a onclick="return confirm(confirmMsg)" class="loading-label" href="{{action('UMeterSubsidiariesController@getEdit', [$row->id])}}">{{App\Language::trans('Edit')}}</a> | 
								<a class="loading-label" href="{{action('UMeterSubsidiariesController@getView', [$row->id])}}">{{App\Language::trans('View')}}</a>
							</td>
						</tr>
						@endforeach
