...
<head>
  ...
  <title>{{App\Language::trans('Power Management')}}</title>
  ...
  <!-- vector map CSS -->
  <link rel="stylesheet" href="{{asset('version_2/vendors/vectormap/jquery-jvectormap-2.0.3.css')}}?ver={{App\Setting::version()}}">

  <!-- Toggles CSS -->
  <link rel="stylesheet" href="{{asset('version_2/vendors/jquery-toggles/css/toggles.css')}}?ver={{App\Setting::version()}}">
  <link rel="stylesheet" href="{{asset('version_2/vendors/jquery-toggles/css/themes/toggles-light.css')}}?ver={{App\Setting::version()}}">

  <!-- Custom CSS -->
  <link rel="stylesheet" href="{{asset('version_2/dist/css/style.css')}}?ver={{App\Setting::version()}}">
