...
<div class="row copyright" style="z-index: auto; position: fixed; bottom: 0px; left: 0px; width:100%;padding-bottom:2%;">
        <ul class="box-set">
            <li class="box" style="margin:0;width:25%;text-align:center;box-sizing:border-box"><a class="nav-link" href="{{action('AppsUtilityChargesController@getDashboard')}}"><i class="material-icons">home</i><br>Home</a></li>
            <li  class="box" style="margin:0;width:25%;text-align:center;box-sizing:border-box"><a class="nav-link" href="{{action('AppsUtilityChargesController@getTransactionListing')}}" ><i class="material-icons">event</i><br>Transaction</a></li>
            <li  class="box" style="margin:0;width:25%;text-align:center;box-sizing:border-box"><a class="nav-link" href="{{action('AppsUtilityChargesController@getTopUp')}}?amount=2" ><i class="material-icons"></i><br>Top Up</a></li>
            <li  class="box" style="margin:0;width:25%;text-align:center;box-sizing:border-box"><a class="nav-link" href="{{action('AppsIETransactionsController@getAccount')}}" ><i class="material-icons">account_box</i><br>Help</a></li>
        </ul>
</div>
