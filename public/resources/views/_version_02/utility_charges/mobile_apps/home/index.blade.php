...
@section('content')
<!-- CATEGORY -->
<div class="section home-category fullscreen flex-ppal-setup app-bgc" style="margin:2% 2% -35% 2%;">
  <!-- <div class="container"> -->
  <div> 
     <!-- padding-top:0px; -->
    ...
    <div class="row slick-product">
        ...
        <div class="col s4 m4 l2"><a class="icon-content nav-link" onclick="initialize_usage_line_chart('barChart');">
        ...
        <div class="col s4 m4 l2"><a class="icon-content nav-link" onclick="initialize_mobile_app_report('barChart');">
          <div class="content fadetransition">
            <div class="in-content">
              <div class="in-in-content">
        ...
        <div class="col s4 m4 l2"><a class="icon-content nav-link" href="{{action('AppsUtilityChargesController@getTopUp')}}?amount=2">
          <div class="content fadetransition">
            <div class="in-content">
              <div class="in-in-content">
