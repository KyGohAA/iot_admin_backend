                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a onclick="return confirm(confirmMsg)" class="loading-label" href="{{action('UMeterRefundsController@getEdit', [$row->id])}}">{{App\Language::trans('Edit')}}</a> |
                                <a class="loading-label" href="{{action('UMeterRefundsController@getView', [$row->id])}}">{{App\Language::trans('View')}}</a> |
                                <a onclick="return confirm(confirmMsg)" class="loading-label" href="{{action('UMeterRefundsController@getDelete', [$row->id])}}">{{App\Language::trans('Del')}}</a>
                            </td>
                        </tr>
                        @endforeach
