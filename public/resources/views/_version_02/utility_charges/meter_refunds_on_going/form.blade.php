    ...
    {!! Form::model($model, ['class'=>'form-horizontal','id'=>'ar-payment-received-form']) !!}
                ...
                <div class="col-xl-4 mb-20">
                    <div class="card mt-30">
                        <div class="card-body bg-light">
                            <h5 class="card-title">{!!Form::select('customer_id', App\Customer::combobox(), null, ['class'=>'form-control','onchange'=>'init_customer_info_pmarr(this,"meter")']) !!}</h5>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-profile-feed">
                    <div class="card-header card-header-action">
                        <h6><span>{{App\Language::trans('Account Information')}} <span class="badge badge-soft-primary ml-5"></span></span></h6>
                    ...
                    <div class="col-4 border-right pr-0">
                        <div class="pa-15">
                            <span class="d-block display-6 text-dark mb-5"><label id="lbl_total_payable_amount"><img src="{{asset(App\Setting::LOADING_GIF)}}" alt=""/></label></span>
                            <span class="d-block text-capitalize font-14"> {{App\Language::trans('Payable Amount')}}</span>
                        </div>
                    </div>
                    <div class="col-4 border-right px-0">
                        <div class="pa-15">
                            <span class="d-block display-6 text-dark mb-5"><label id="lbl_total_paid_amount"><img src="{{asset(App\Setting::LOADING_GIF)}}" alt=""/></label></span>
                            <span class="d-block text-capitalize font-14">{{App\Language::trans('Paid Amount')}}</span>
                        </div>
                    </div>
                    <div class="col-4 pl-0">
                        <div class="pa-15">
                            <span class="d-block display-6 text-dark mb-5"><label id="lbl_total_refund_amount"><img src="{{asset(App\Setting::LOADING_GIF)}}" alt=""/></label></span>
                            <span class="d-block text-capitalize font-14">{{App\Language::trans('Refundable Amount')}}</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-12 mb-20">
                     @include('_version_02.utility_charges.meter_refunds_on_going.partials._list_by_payment_received')
                </div>
            </div>
        </section>
            ...
            <div class="row">
                <div class="col-xl-8 mb-20">
                        ...
                        <div class="form-group{{ $errors->has('document_date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                {!! Form::text('document_date', null, ['class'=>'form-control','required','readonly']) !!}
                        ...
                        <div class="form-group{{ $errors->has('document_no') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                {!! Form::text('document_no', null, ['class'=>'form-control','required','readonly']) !!}
                        ...
                        <div class="form-group{{ $errors->has('deposit_to_account') ? ' has-error' : '' }}">
                            {!! Form::label('deposit_to_account', App\Language::trans('Refund From'), ['class'=>'control-label col-md-4']) !!}
                            <div class="col-md-12">
                        ...
                        <div class="form-group{{ $errors->has('reference_no') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                {!!$errors->first('reference_no', '<label for="reference_no" class="help-block error">:message</label>')!!}   
                                 {!! Form::text('reference_no', null, ['class'=>'form-control','autofocus','required','onblur' => 'reference_no_format_checker(this)','readonly']) !!} 
                            </div>
                        </div>
                </div>
