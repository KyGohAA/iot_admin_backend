...
<section class="hk-sec-wrapper">
    <h5 class="hk-sec-title">{{App\Language::trans('Bank Detail')}}</h5><hr>
    <div class="row">
			<div class="col-md-6">
						 ...
						 <div class="row">	
						 	<div class="col-md-3">
							    <div class="custom-control custom-radio">
							        <input type="radio" id="status_on" name="status" value=1  class="custom-control-input" {{isset($model['status']) == true ? ($model['status'] == true ? 'checked' : '') : 'checked'}}>
