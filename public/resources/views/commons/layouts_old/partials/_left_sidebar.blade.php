  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{action('UMeterRegistersController@getStatusDetail')}}"><i class="fa fa-tablet fa-fw"></i> <span>{{App\Language::trans('Current Power (Admin)')}}</span></a></li>
        ...
        @endif
          ...
          <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{action('ARPaymentReceivedsController@getIndex')}}"><i class="fa fa-file-o fa-fw"></i> <span>{{App\Language::trans('Payment Received')}}</span></a></li>
          	    <li><a href="{{action('ARRefundsController@getIndex')}}"><i class="fa fa-file-o fa-fw"></i> <span>{{App\Language::trans('Refund')}}</span></a></li>
              </ul>
          </li>     
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{action('HelpsController@getIndex')}}"><i class="fa fa-book fa-fw"></i> <span>{{App\Language::trans('Help Settings')}}</span></a></li>
