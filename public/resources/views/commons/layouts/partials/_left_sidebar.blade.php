  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{action('OpencartUsersController@getLogin')}}"><i class="fa fa-dashboard fa-fw"></i> <span>{{App\Language::trans('Login')}}</span></a></li>
        <li><a href="{{action('DashboardsController@getDashboard')}}"><i class="fa fa-dashboard fa-fw"></i> <span>{{App\Language::trans('Dashboard')}}</span></a></li>
        <li><a href="{{action('InternalTicketsController@getIndex')}}"><i class="fa fa-tags fa-fw"></i> <span>{{App\Language::trans('Ticket')}}</span></a></li>
        @if(App\LeafAPI::get_module_status([App\LeafAPI::label_power_meter]))
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="{{action('UMeterReadingController@getIndex')}}"><i class="fa fa-tablet fa-fw"></i> <span>{{App\Language::trans('Meter Reading Status')}}</span></a></li>
          ...
          <li class="treeview">
            <a href="#">
              <i class="fa fa-sort-alpha-asc fa-fw"></i> <span>{{App\Language::trans('Developers')}}</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href="{{action('DevelopersController@getPaymentTestIndex')}}"><i class="fa fa-paste fa-fw"></i> <span>{{App\Language::trans('Payment Test')}}</span></a></li>
            </ul>
          </li>        
        @endif
        ...
        <li class="treeview">
         ...
         <li class="treeview">
          <a href="#">
            <i class="fa fa-sort-alpha-asc fa-fw"></i> <span>{{App\Language::trans('Language Settings')}}</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-sort-alpha-asc fa-fw"></i> <span>{{App\Language::trans('Product Settings')}}</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">   
            <li><a href="{{action('OCProductsController@getIndex', 'index')}}"><i class="fa fa-user fa-fw"></i> <span>{{App\Language::trans('Main Warehouse')}}</span></a></li>
            <li><a href="{{action('OCProductsController@getIndex', 'is_prepare_to_store')}}"><i class="fa fa-users fa-fw"></i> <span>{{App\Language::trans('Active Product')}}</span></a></li>
            <li><a href="{{action('OCProductsController@getIndex', 'is_removed')}}"><i class="fa fa-users fa-fw"></i> <span>{{App\Language::trans('Removed Product')}}</span></a></li>        
          </ul>
