		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
					...
					<div class="col-md-10">
						<p class="form-control-static">{!!html_entity_decode($model->description)!!}</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="form-group{{ $errors->has('solution') ? ' has-error' : '' }}">
						...
						<div class="col-md-8">
							<p class="form-control-static">{!!html_entity_decode($row->solution)!!}</p>
						</div>
					</div>
				</div>
			</div>
