...
<div class="box">
	<div class="box-header with-border">
		...
		<div class="box-tools pull-right">
			<a href="{{action('PaymentTestingAllowListsController@getNew')}}" class="btn btn-block btn-info">
					...
					@foreach($model as $index => $row)
						<tr>   
							...
							<td class="text-center">
								<a onclick="return confirm(confirmMsg)" href="{{action('PaymentTestingAllowListsController@getEdit', [$row->id])}}">{{App\Language::trans('Edit')}}</a> | 
