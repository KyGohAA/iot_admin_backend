                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a onclick="return confirm(confirmMsg)" href="{{action('UMeterRefundsController@getEdit', [$row->id])}}">{{App\Language::trans('Edit')}}</a> |
                            <a href="{{action('UMeterRefundsControllerR@getView', [$row->id])}}">{{App\Language::trans('View')}}</a> |
                            <a onclick="return confirm(confirmMsg)" href="{{action('UMeterRefundsController@getDelete', [$row->id])}}">{{App\Language::trans('Del')}}</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
