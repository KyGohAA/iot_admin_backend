        ...
        <div class="box box-info box-solid" style="background-color:#b3d9fc;  height:100%;">
            ...
            <div class="box-body">
               <!--  <small>{{App\Language::trans('Until')}}</small> -->
                ...
                <div class="block">
                    {{App\Language::trans(date('M'))}} {{App\Language::trans('usage amount')}} :
                    <br>
                    <strong>RM {{$statistic['currentUsageCharges']}}</strong> : <strong>{{$statistic['current_month_usage']}} {{App\Language::trans('kWh')}}</strong>
                    <br>
