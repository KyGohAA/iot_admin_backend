  <footer class="main-footer">
    ...
    <strong>{{App\Language::trans('Copyright')}} &copy; 2017-2018 <a href="https://leaf.com.my">{{App\Language::trans('Leaf Smart City')}}</a>.</strong> {{App\Language::trans('All rights reserved')}}.
  </footer>
