                    ...
                    @foreach($model as $index => $row)
                        <tr>
                            ...
                            <td class="text-center">
                               <!--  <a onclick="return confirm(confirmMsg)" href="{{action('ARPaymentReceivedsController@getEdit', [$row->id])}}">{{App\Language::trans('Edit')}}</a> |  -->
                                <a href="{{action('ARPaymentReceivedsController@getView', [$row->id])}}">{{App\Language::trans('View')}}</a> | 
                                <a target="_blank" href="{{action('ARPaymentReceivedsController@getPrint', [$row->id])}}">{{App\Language::trans('Print')}}</a> | 
                                <a onclick="return confirm(confirmMsg)" href="{{action('ARPaymentReceivedsController@getDelete', [$row->id])}}">{{App\Language::trans('Del')}}</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
