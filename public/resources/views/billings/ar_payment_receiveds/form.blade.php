...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title">{{App\Language::trans('Received Payment Flow')}}</h3>
    ...
    <form class="form-horizontal">
        <div class="box-body">
            <div class="row">
                ...
                <div class="row step-div" id="div_step_1">
                    <div class="col-md-12">
                ...
                <div class="row hide step-div" id="div_step_2">
                    <div class="col-md-12">
                ...
                <div class="row hide step-div" id="div_step_3">
                    <div class="col-md-12">
                ...
                <div class="row hide step-div" id="div_step_4">
                    <div class="col-md-12">
                ...
                <div class="row hide step-div" id="div_step_5">
                    <div class="col-md-12">
        ...
        <div class="box-footer">
            <label onclick="go_to_step(get_current_step(),'backward');" class="btn btn-default">Back</label>
            <label onclick="go_to_step(get_current_step(),'forward');" class="btn btn-info pull-right">Next</label>
        </div>
        <!-- /.box-footer -->
    </form>
</div>
...
<div class="box box-default collapsed-box">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            {{App\Language::trans('More info')}} <i class="fa fa-arrow-circle-right" data-widget="collapse"></i>
        </div>
    </div>
