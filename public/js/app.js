...
// leaf webview javascript coding here
...
window.init_state_selectbox = function (me) {
    var stateSelectbox = $("select[name*=state_id]");
...
window.init_city_selectbox = function (me) {
    var citySelectbox = $("select[name*=city_id]");
    citySelectbox.empty();
