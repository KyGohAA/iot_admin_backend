    ...
    <div id="wrapper">
        <div class="vertical-align-wrap">
            <div class="vertical-align-middle auth-main">
                <div class="auth-box">
                    <div class="top">
                        <img style='height:60px;width:60px;display: inline;margin-bottom:15px;' src="{{isset($company['system_logo_path']) ? asset($company['system_logo_path']) : asset('_app_icon.png')}}" alt="Lucid">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            {!!Form::model($model, ['class'=>'form-auth-small'])!!}
