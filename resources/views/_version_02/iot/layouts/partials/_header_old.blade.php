    ...
    <div class="hk-wrapper hk-vertical-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar">
            ...
            <a class="navbar-brand">
                <img class="brand-img d-inline-block" style="height:30px; width: :30px;" src="{{asset(App\Company::get_company_logo())}}" alt="brand" /><span style="margin-left:10px;">{{App\Language::trans(App\Company::get_system_name())}}</span>
            </a>
            ...
            <ul class="navbar-nav hk-navbar-content">
                ...
                <li class="nav-item dropdown dropdown-authentication">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                        <a class="dropdown-item" href="{{action('DashboardsController@getUserProfile')}}"><i class="dropdown-icon zmdi zmdi-account"></i><span>Profile</span></a>
                        ...
                        <!-- <div class="dropdown-divider"></div>
                        <div class="dropdown-item"></i><span>{!! Form::select('state_id', App\State::combobox(), null, ['class'=>'form-control']) !!}</span></div> -->      
                        <div class="dropdown-divider"></div>      
                        <a class="dropdown-item" href="{{action('OpencartUsersController@getLogout')}}"><i class="dropdown-icon zmdi zmdi-power"></i><span>Log out</span></a>
                    </div>
                </li>
            </ul>
        </nav>
