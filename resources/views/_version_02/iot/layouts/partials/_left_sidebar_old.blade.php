            ...
            <div class="nicescroll-bar">
                ...
                <div class="row">
                        ...
                        <div class="col-md-11 mt-15" style="margin-left:2%;">
                            @php  $selected_group_id = Cookie::get('group_id'); @endphp
                            {!! Form::select('leaf_group_id', App\UserAssign::groupCombobox(), $selected_group_id, ['class'=>'form-control select2','onchange'=>'init_group_change(this)']) !!}
                            {!!$errors->first('leaf_group_id', '<label for="leaf_group_id" class="help-block error">:message</label>')!!}
                        </div>
                            ...
                            <ul id="monitorings_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{action('MeterRelayTestsController@getIndex')}}">{{App\Language::trans('Remote On/Off History')}}</a>
                                        </li>
...
<!-- 
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            <a class="nav-link" href="javascript:void(0);" data-toggle="collapse" data-target="#util_drp">
                                <span class="feather-icon"><i data-feather="archive"></i></span>
                                <span class="nav-link-text">{{App\Language::trans('Utility Fee')}}</span>
                            </a>
                            <ul id="util_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                             <!-- loading-label -->
                                            <a class="nav-link" href="{{action('UtilHouseController@getIndex')}}">{{App\Language::trans('House')}}</a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" href="{{action('UtilRoomsController@getIndex')}}">{{App\Language::trans('Room')}}</a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" href="{{action('UtilityFeesController@getIndex')}}">{{App\Language::trans('Utillity Fee')}}</a>
                                        </li>
        ...
        <script type="text/javascript">
            var updateSelectedGroupxUrl = "{{action('SettingsController@updateSelectedGroup')}}";
