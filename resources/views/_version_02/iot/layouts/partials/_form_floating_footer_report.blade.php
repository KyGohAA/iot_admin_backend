<div id='footer'  class="box-footer">
	<div class="row">
		...
		<!--  loading-label -->
			<button  target="_blank" id="submit_button" type="submit" class="btn btn-primary btn-wth-icon icon-wthot-bg btn-lg pull-right" onclick="generate_report_msg(this);"><i class="fa fa-search fa-fw"></i>{{App\Language::trans('Search')}}</button>			
		</div>
	</div>
</div>