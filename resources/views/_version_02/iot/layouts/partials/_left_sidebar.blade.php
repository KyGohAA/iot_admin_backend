<div id="left-sidebar" class="sidebar">
        <div class="sidebar-scroll">
            <div class="user-account">
                <img style="margin-top:7px;" src="{{Auth::user()->profile_jpg()}}" class="rounded-circle user-photo" alt="User Profile Picture">
                <div class="dropdown">
                    <span>Welcome,</span>
                    <a href="javascript:void(0);" class="user-name" data-toggle="dropdown"><strong>{{Auth::user()->fullname}}</strong></a>
                ...
                <div class="tab-pane active" id="admin">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active"><a href="{{action('IOTUniversalsController@getDashboard')}}"><i class="icon-home"></i><span>Dashboard</span></a></li>
                            <li><a href="{{action('IOTUniversalsController@getIndex', ['user'])}}"><i class="icon-users"></i> <span>Users</span></a></li>
                            
                             <li><a href="{{action('IOTUniversalsController@getIndex', ['network_server'])}}"><i class="icon-control-pause"></i> <span>Network Server</span></a></li>
                             <li><a href="{{action('IOTUniversalsController@getIndex', ['gateway'])}}"><i class="icon-notebook"></i> <span>Gateways</span></a></li>
                             <li><a href="{{action('IOTUniversalsController@getIndex', ['application'])}}"><i class="icon-list"></i> <span>Applications</span></a></li>
                             <li><a href="{{action('IOTUniversalsController@getIndex', ['device'])}}"><i class="icon-share fa-rotate-90 d-inline-block"></i> <span>Devices</span></a></li>
