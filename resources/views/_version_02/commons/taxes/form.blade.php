...
<section class="hk-sec-wrapper">
    <h5 class="hk-sec-title">{{App\Language::trans('Tax Detail')}}</h5><hr>
    ...
    <div class="row">
		...
		<div class="col-md-6">
			<div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
				...
				<div class="col-md-8">
					{!! Form::select('type', App\Tax::type_combobox(), null, ['class'=>'form-control','required']) !!}
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group{{ $errors->has('rate') ? ' has-error' : '' }}">
				...
				<div class="col-md-8">
					{!! Form::text('rate', null, ['class'=>'form-control','autofocus','required']) !!}
