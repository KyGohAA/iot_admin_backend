                            ...
                            <ul id="Components_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link loading-label" href="{{action('SettingsController@getIndex')}}">{{App\Language::trans('Company')}}</a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <ul id="usages_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link loading-label" href="{{action('ReportsController@getRoomUsages')}}">{{App\Language::trans('Room Usages')}}</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <ul id="billings_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link loading-label" href="{{action('UMeterSubsidiariesController@getIndex')}}">{{App\Language::trans('Subsidy')}}</a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <ul id="developers_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link loading-label" href="{{action('DevelopersController@getPaymentTestIndex')}}">{{App\Language::trans('Payment Test')}}</a>
                                        </li>
                                    </ul>
                                </li>
