...
@endphp
 ...
 <!-- ION CSS -->
 <link rel="stylesheet" href="{{asset('version_2/vendors/ion-rangeslider/css/ion.rangeSlider.css')}}">
 <link rel="stylesheet" href="{{asset('version_2/vendors/ion-rangeslider/css/ion.rangeSlider.skinHTML5.css')}}">
...
<div class="box">
	...
	<ul class="nav nav-light nav-tabs bo" role="tablist">
		...
		<li role="presentation" class="nav-item active">
			<a href="#general_setting" aria-controls="general_setting" class="d-flex align-items-center nav-link active" role="tab" data-toggle="tab"><h5>{{App\Language::trans('General Setting')}}</h5></a>
		</li>

		@if(App\Company::is_allow_to_access_module(App\Setting::LABEL_MODULE_POWER_MANAGEMENT))
			<li role="presentation" class="nav-item">
				<a href="#power_management" aria-controls="power_management" class="d-flex align-items-center nav-link" role="tab" data-toggle="tab"><h5>{{App\Language::trans('Power Management')}}</h5></a>
			</li>
		@endif

		@if(App\Company::is_allow_to_access_module(App\Setting::LABEL_MODULE_ACCOUNTING))
			<li role="presentation" class="nav-item">
				<a href="#club_house" aria-controls="club_house" class="d-flex align-items-center nav-link" role="tab" data-toggle="tab"><h5>{{App\Language::trans('Club House')}}</h5></a>
			</li>
		@endif

		@if(App\Company::is_allow_to_access_module(App\Setting::LABEL_MODULE_ACCOUNTING))
			<li role="presentation" class="nav-item">
				<a href="#leaf_accounting" aria-controls="leaf_accounting" class="d-flex align-items-center nav-link" role="tab" data-toggle="tab"><h5>{{App\Language::trans('Leaf Accounting')}}</h5></a>
			</li>
		@endif
	</ul>
	<hr>
	...
	<div class="tab-content">	
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group{{ $errors->has('system_live_date') ? ' has-error' : '' }}">
							...
							<div class="col-md-8">
								{!! Form::select('default_admin_user_group_id', App\UserGroup::combobox(), null, ['class'=>'form-control']) !!}
	                            	{!!$errors->first('payment_gateway', '<label for="payment_gateway" class="help-block error">:message</label>')!!}
							</div>
						</div>
					</div>
				</div>
		...
		<div role="tabpanel" class="tab-pane" id="power_management">
			...
			<ul class="nav nav-light nav-tabs bo" role="tablist">
				...
				<li role="presentation" class="nav-item">
					<a href="#pm_billing_setting" aria-controls="pm_billing_setting" class="d-flex align-items-center nav-link fs-16 zero-padding" role="tab" data-toggle="tab">{{App\Language::trans('Mobile App Pagement Page')}}</a>
				</li>

				<li role="presentation" class="nav-item">
					<a href="#pm_mobile_app_payment" aria-controls="pm_mobile_app_payment" class="d-flex align-items-center nav-link fs-16 zero-padding" role="tab" data-toggle="tab">{{App\Language::trans('Billing Setup')}}</a>
				</li>

				<li role="presentation" class="nav-item">
					<a href="#pm_operational_setting" aria-controls="pm_operational_setting" class="d-flex align-items-center nav-link fs-16 zero-padding" role="tab" data-toggle="tab">{{App\Language::trans('Payment Reminder Setting')}}</a>
				</li>

				<li role="presentation" class="nav-item">
					<a href="#pm_msg_and_email_content" aria-controls="pm_msg_and_email_content" class="d-flex align-items-center nav-link fs-16 zero-padding" role="tab" data-toggle="tab">{{App\Language::trans('Mobile App Msg and Email Content Setting')}}</a>
				</li>

				<li role="presentation" class="nav-item">
					<a href="#pm_admin_operational_setting" aria-controls="pm_admin_operational_setting" class="d-flex align-items-center nav-link fs-16 zero-padding" role="tab" data-toggle="tab">{{App\Language::trans('Operational Setting')}}</a>
				</li>

				<li role="presentation" class="nav-item">
					<a href="#pm_uat_setting" aria-controls="pm_uat_setting" class="d-flex align-items-center nav-link fs-16 zero-padding" role="tab" data-toggle="tab">{{App\Language::trans('UAT Setup')}}</a>
				</li>
				<li role="presentation" class="nav-item">
					<a href="#pm_onoff_setting" aria-controls="pm_onoff_setting" class="d-flex align-items-center nav-link fs-16 zero-padding" role="tab" data-toggle="tab">{{App\Language::trans('Power On/Off Setup')}}</a>
				</li>
			</ul>		
			<hr>
	...
	<div class="tab-content">	
	    <div role="tabpanel" class="tab-pane active" id="pm_billing_setting">
	    		...
	    		<!-- <h6 class="hk-sec-title">{{App\Language::trans('Top Up Setting')}}</h6> <hr> -->
				...
				<div class="row">
					<div class="col-md-6">
	                		<div class="form-group{{ $errors->has('payment_gateway') ? ' has-error' : '' }}">
	                            ...
	                            <div class="col-md-8">
	                            	{!! Form::select('payment_gateway', App\Setting::payment_gateway_combobox(), null, ['class'=>'form-control','required' , 'disabled'=>'true']) !!}
	                            	{!!$errors->first('payment_gateway', '<label for="payment_gateway" class="help-block error">:message</label>')!!}
	                        	</div>
	                        </div>
	                </div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group{{ $errors->has('is_mobile_app_maintenance') ? ' has-error' : '' }}">
							{!! Form::label('is_mobile_app_maintenance', App\Language::trans('Is Maintenance Mode'), ['class'=>'control-label col-md-12']) !!}
							<div class="col-md-12">
								 <div class="row">	
								 	<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=1 {{isset($model->is_mobile_app_maintenance) == true ? ($model->is_mobile_app_maintenance == true ? 'checked' : '') : 'checked'}}  value=1 id="is_mobile_app_maintenance_on" name="is_mobile_app_maintenance" checked class="custom-control-input">
									        <label class="custom-control-label" for="is_mobile_app_maintenance_on">{{App\Language::trans('Enabled')}}</label>
									    </div>
									</div>
									<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=0 {{isset($model->is_mobile_app_maintenance) == true ? ($model->is_mobile_app_maintenance == false ? 'checked' : '') : ''}}  id="is_mobile_app_maintenance_off" name="is_mobile_app_maintenance"  class="custom-control-input">
									        <label class="custom-control-label" for="is_mobile_app_maintenance_off">{{App\Language::trans('Disabled')}}</label>
									    </div>
									</div>
								 </div>
								 {!!$errors->first('is_mobile_app_maintenance', '<label for="is_mobile_app_maintenance" class="help-block error">:message</label>')!!}
							</div>
						</div>
					</div>
						...
						<div class="form-group{{ $errors->has('is_mobile_app_allow_payment') ? ' has-error' : '' }}">
							...
							<div class="col-md-12">
								 <div class="row">	
								 	<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=1 {{isset($model->is_mobile_app_allow_payment) == true ? ($model->is_mobile_app_allow_payment == true ? 'checked' : '') : 'checked'}}  value=1 id="is_mobile_app_allow_payment_on" name="is_mobile_app_allow_payment" checked class="custom-control-input">
									        <label class="custom-control-label" for="is_mobile_app_allow_payment_on">{{App\Language::trans('Enabled')}}</label>
									    </div>
									</div>
									<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=0 {{isset($model->is_mobile_app_allow_payment) == true ? ($model->is_mobile_app_allow_payment == false ? 'checked' : '') : ''}}  value=1 id="is_mobile_app_allow_payment_off" name="is_mobile_app_allow_payment"  class="custom-control-input">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group{{ $errors->has('is_top_up_with_predefined_value') ? ' has-error' : '' }}">
							{!! Form::label('is_top_up_with_predefined_value', App\Language::trans('Top Up With Predefined Value'), ['class'=>'control-label col-md-12']) !!}
							<div class="col-md-12">
								 <div class="row">	
								 	<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=1 {{isset($model->is_top_up_with_predefined_value) == true ? ($model->is_top_up_with_predefined_value == true ? 'checked' : '') : 'checked'}}  value=1 id="is_top_up_with_predefined_value_on" name="is_top_up_with_predefined_value" checked class="custom-control-input">
									        <label class="custom-control-label" for="is_top_up_with_predefined_value_on">{{App\Language::trans('Yes')}}</label>
									    </div>
									</div>
									<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=0 {{isset($model->is_top_up_with_predefined_value) == true ? ($model->is_top_up_with_predefined_value == false ? 'checked' : '') : ''}} id="is_top_up_with_predefined_value_off" name="is_top_up_with_predefined_value"  class="custom-control-input">
									        <label class="custom-control-label" for="is_top_up_with_predefined_value_off">{{App\Language::trans('No')}}</label>
									    </div>
									</div>
								 </div>
								 {!!$errors->first('is_top_up_with_predefined_value', '<label for="is_top_up_with_predefined_value" class="help-block error">:message</label>')!!}
							</div>
						</div>
					</div>

					<div class="col-md-6">
						<div class="form-group{{ $errors->has('power_meter_top_up_predefined_value') ? ' has-error' : '' }}">
							{!! Form::label('power_meter_top_up_predefined_value', App\Language::trans('Top Up Predefined Value').'', ['class'=>'control-label col-md-12']) !!}
							
							<div class="col-md-8">
								{!! Form::text('power_meter_top_up_predefined_value', null, ['class'=>'form-control','required']) !!}
		                        {!!$errors->first('power_meter_top_up_predefined_value', '<label for="power_meter_top_up_predefined_value" class="help-block error">:message</label>')!!}
							</div>
							<div class="col-md-12">
									<small>{{App\Language::trans('Separate by comma , e.g. 5,10,15 .')}}</small>
							</div>
						</div>
					</div>
	    ...
	    <div role="tabpanel" class="tab-pane" id="pm_mobile_app_payment">
	    	<!-- <h6 class="hk-sec-title mt-15">{{App\Language::trans('Billing Setting')}}</h6> <hr> -->
						...
						<div class="form-group{{ $errors->has('is_prepaid') ? ' has-error' : '' }}">
							...
							<div class="col-md-12">
								 <div class="row">	
								 	<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio"   value=1 {{isset($model->is_prepaid) == true ? ($model->is_prepaid == true ? 'checked' : '') : 'checked'}} id="is_prepaid_on" name="is_prepaid"  class="custom-control-input">
									        <label class="custom-control-label" for="is_prepaid_on">{{App\Language::trans('Prepaid')}}</label>
									    </div>
									</div>
									<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=0 {{isset($model->is_prepaid) == true ? ($model->is_prepaid == false ? 'checked' : '') : ''}} id="is_prepaid_off" name="is_prepaid"  class="custom-control-input">
						...
						<div class="form-group{{ $errors->has('is_min_credit') ? ' has-error' : '' }}">
							...
							<div class="col-md-12">
								 <div class="row">	
								 	<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=1 {{isset($model->is_min_credit) == true ? ($model->is_min_credit == true ? 'checked' : '') : 'checked'}}  value=1 id="is_min_credit_on" name="is_min_credit" checked class="custom-control-input">
									        <label class="custom-control-label" for="is_min_credit_on">{{App\Language::trans('Enabled')}}</label>
									    </div>
									</div>
									<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=0 {{isset($model->is_min_credit) == true ? ($model->is_min_credit == false ? 'checked' : '') : ''}}  id="is_min_credit_off" name="is_min_credit"  class="custom-control-input">
						...
						<div class="form-group{{ $errors->has('is_transaction_charge') ? ' has-error' : '' }}">
							...
							<div class="col-md-12">
								 <div class="row">	
								 	<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=1 {{isset($model->is_transaction_charge) == true ? ($model->is_transaction_charge == true ? 'checked' : '') : 'checked'}}  value=1 id="is_transaction_charge_on" name="is_transaction_charge" checked class="custom-control-input">
									        <label class="custom-control-label" for="is_transaction_charge_on">{{App\Language::trans('Enabled')}}</label>
									    </div>
									</div>
									<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=0 {{isset($model->is_transaction_charge) == true ? ($model->is_transaction_charge == false ? 'checked' : '') : ''}} id="is_transaction_charge_off" name="is_transaction_charge"  class="custom-control-input">
						...
						<div class="form-group{{ $errors->has('is_inclusive') ? ' has-error' : '' }}">
							...
							<div class="col-md-12">
								 <div class="row">	
								 	<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=1 {{isset($model->is_inclusive) == true ? ($model->is_inclusive == true ? 'checked' : '') : 'checked'}}  value=1 id="is_inclusive_on" name="is_inclusive" checked class="custom-control-input">
									        <label class="custom-control-label" for="is_inclusive_on">{{App\Language::trans('Inclusive')}}</label>
									    </div>
									</div>
									<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=0 {{isset($model->is_inclusive) == true ? ($model->is_inclusive == false ? 'checked' : '') : ''}} id="is_inclusive_off" name="is_inclusive"  class="custom-control-input">
						...
						<div class="form-group{{ $errors->has('is_pay_by_accumulate') ? ' has-error' : '' }}">
							...
							<div class="col-md-12">
								 <div class="row">	
								 	<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=1 {{isset($model->is_pay_by_accumulate) == true ? ($model->is_pay_by_accumulate == true ? 'checked' : '') : 'checked'}}  value=1 id="is_pay_by_accumulate_on" name="is_pay_by_accumulate" checked class="custom-control-input">
									        <label class="custom-control-label" for="is_pay_by_accumulate_on">{{App\Language::trans('Accumulate')}}</label>
									    </div>
									</div>
									<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=0 {{isset($model->is_pay_by_accumulate) == true ? ($model->is_pay_by_accumulate == false ? 'checked' : '') : ''}} id="is_pay_by_accumulate_off" name="is_pay_by_accumulate"  class="custom-control-input">
	    ...
	    <div role="tabpanel" class="tab-pane" id="pm_operational_setting">
						...
						<!-- <div class="row mb-15">
						    <div class="col-sm">
						        <div class="media pa-20 border border-2 border-light rounded">
						            <img class="mr-15 circle d-74" src="{{asset('img/red_information.png')}}" alt="Generic placeholder image">
						            <div class="media-body">
						                <h6 class="mb-5">{{App\Language::trans('Automation Setting Description')}}</h6>
						                 {{App\Language::trans($message)}}
						            </div>
						        </div>
						    </div>
						</div> -->
					...
					<!-- <h6 class="hk-sec-title mt-15">{{App\Language::trans('Power Meter Operational Setting')}}</h6> <hr> -->
						<div class="row">
							<div class="col-md-6">
								<div class="form-group{{ $errors->has('power_meter_operational_setting[power_supply_on_off_automation]') ? ' has-error' : '' }}">
									...
									<div class="col-md-12">
										 <div class="row">	
										 	<div class="col-md-3">
											    <div class="custom-control custom-radio">
											        <input type="radio" value=1 {{isset($power_meter_operational_setting['power_supply_on_off_automation']) == true ? ($power_meter_operational_setting['power_supply_on_off_automation'] == true ? 'checked' : '') : 'checked'}}  value=1 id="power_meter_operational_setting[power_supply_on_off_automation]_on" name="power_meter_operational_setting[power_supply_on_off_automation]" checked class="custom-control-input">
											        <label class="custom-control-label" for="power_meter_operational_setting[power_supply_on_off_automation]_on">{{App\Language::trans('Yes')}}</label>
											    </div>
											</div>
											<div class="col-md-3">
											    <div class="custom-control custom-radio">
											        <input type="radio" value=0 {{isset($power_meter_operational_setting['power_supply_on_off_automation']) == true ? ($power_meter_operational_setting['power_supply_on_off_automation'] == false ? 'checked' : '') : ''}} id="power_meter_operational_setting[power_supply_on_off_automation]_off" name="power_meter_operational_setting[power_supply_on_off_automation]"  class="custom-control-input">
											        <label class="custom-control-label" for="power_meter_operational_setting[power_supply_on_off_automation]_off">{{App\Language::trans('No')}}</label>
											    </div>
											</div>
										 </div>
										 {!!$errors->first('power_meter_operational_setting[power_supply_on_off_automation]', '<label for="power_meter_operational_setting[power_supply_on_off_automation]" class="help-block error">:message</label>')!!}
									</div>
								</div>
							</div>
						</div>
										 ...
										 <div class="row">	
										 	<div class="col-md-3">
											    <div class="custom-control custom-radio">
											        ...
											        <label class="custom-control-label" for="power_meter_operational_setting[is_auto_turn_off_meter]_on">{{App\Language::trans('Yes')}}</label>
											    </div>
											</div>
											<div class="col-md-3">
											    <div class="custom-control custom-radio">
											        ...
											        <label class="custom-control-label" for="power_meter_operational_setting[is_auto_turn_off_meter]_off">{{App\Language::trans('No')}}</label>
											    </div>
											</div>
										 </div>
					 ...
					 <hr><h6 class="hk-sec-title mt-15">{{App\Language::trans('MailBox Setting')}}</h6> <hr>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group{{ $errors->has('power_meter_mailbox_setting[smtp_password]') ? ' has-error' : '' }}">
								...
								<div class="col-md-8">
									{!! Form::text('power_meter_mailbox_setting[smtp_password]', (isset($model->id) ? (isset($power_meter_mailbox_setting['smtp_hostname']) ? $power_meter_mailbox_setting['smtp_password'] : '') : null), ['class'=>'form-control']) !!}
						...
						<div class="col-md-6">
							<div class="form-group{{ $errors->has('power_meter_mailbox_setting[smtp_port]') ? ' has-error' : '' }}">
								...
								<div class="col-md-8">
									{!! Form::number('power_meter_mailbox_setting[smtp_port]', (isset($model->id) ? (isset($power_meter_mailbox_setting['smtp_port']) ? $power_meter_mailbox_setting['smtp_port'] : '') : null), ['class'=>'form-control','step'=>'1','min'=>'1']) !!}
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group{{ $errors->has('power_meter_mailbox_setting[smtp_timeout]') ? ' has-error' : '' }}">
								...
								<div class="col-md-8">
									{!! Form::number('power_meter_mailbox_setting[smtp_timeout]', (isset($model->id) ? (isset($power_meter_mailbox_setting['smtp_timeout']) ? $power_meter_mailbox_setting['smtp_timeout'] : '') : null), ['class'=>'form-control','step'=>'1','min'=>'1']) !!}
	    ...
	    <div role="tabpanel" class="tab-pane" id="pm_msg_and_email_content">
	    		<!-- <h6 class="hk-sec-title mt-15">{{App\Language::trans('Power Meter Mobile App Email and Message Setting')}}</h6> <hr> -->	
			...
			<ul class="nav nav-light nav-tabs bo" role="tablist">
				...
				@foreach($language_listing as $language)
					...
					<li role="presentation" class="nav-item">
						<a href="#{{ $language }}" aria-controls="{{ $language }}" class="d-flex align-items-center nav-link{{ $tab_status }} fs-16 zero-padding" role="tab" data-toggle="tab"><h5>{{App\Language::trans(ucfirst($language))}}</h5></a>
					</li>
				...
				@endphp
					...
					@foreach($language_listing as $language)
					    <div role="tabpanel" class="tab-pane{{ $tab_status }}" id="{{ $language }}">
					    		<h6 class="hk-sec-title mt-15">{{App\Language::trans('Mobile Apps Message Setting')}}</h6> <hr>	
					    	    <div class="row">
										 <div class="col-md-12">
									        	<div class="form-group{{ $errors->has('power_meter_mobile_app_msg[payment_success_msg]['.$language.']') ? ' has-error' : '' }}">
													...
													<div class="col-md-12">
														{!! Form::text('power_meter_mobile_app_msg[payment_success_msg]['.$language.'][title]', (isset($payment_success_msg[$language]->title) ? $payment_success_msg[$language]->title : null), ['class'=>'form-control','placeholder'=>'Title']) !!}
														{!!$errors->first('power_meter_mobile_app_msg[payment_success_msg]['.$language.'][title]', '<label for="power_meter_mobile_app_msg[payment_success_msg]['.$language.'][title]" class="help-block error">:message</label>')!!}
													</div>
													<div class="col-md-12">
														{!! Form::textarea('power_meter_mobile_app_msg[payment_success_msg]['.$language.'][content]', (isset($payment_success_msg[$language]->content) ? $payment_success_msg[$language]->content : null), ['id'=>'power_meter_mobile_app_msg[payment_success_msg]['.$language.'][content]', 'rows'=>'10' , 'cols'=>'80','class'=>'form-control tinymce']) !!}
									                    {!!$errors->first('power_meter_mobile_app_msg[payment_success_msg]['.$language.'][content]', '<label for="power_meter_mobile_app_msg[payment_success_msg]['.$language.'][content]" class="help-block error">:message</label>')!!}
													</div>
												</div>
									       </div>
								   </div>
								   ...
								   <div class="row">
										 <div class="col-md-12">
									        	<div class="form-group{{ $errors->has('power_meter_mobile_app_msg[invalid_email_msg]['.$language.']') ? ' has-error' : '' }}">
													...
													<div class="col-md-12">
														{!! Form::text('power_meter_mobile_app_msg[invalid_email_msg]['.$language.']', (isset($invalid_email_msg[$language]->title) ? $invalid_email_msg[$language]->title : null), ['class'=>'form-control','placeholder'=>'Title']) !!}
														{!!$errors->first('power_meter_mobile_app_msg[invalid_email_msg]['.$language.']', '<label for="power_meter_mobile_app_msg[invalid_email_msg]['.$language.']" class="help-block error">:message</label>')!!}
													</div>
													<div class="col-md-12">
														{!! Form::textarea('power_meter_mobile_app_msg[invalid_email_msg]['.$language.'][content]', (isset($invalid_email_msg[$language]->content) ? $invalid_email_msg[$language]->content : null), ['id'=>'power_meter_mobile_app_msg[invalid_email_msg]['.$language.'][content]', 'rows'=>'10' , 'cols'=>'80','class'=>'form-control tinymce']) !!}
									                    {!!$errors->first('power_meter_mobile_app_msg[invalid_email_msg]['.$language.'][content]', '<label for="power_meter_mobile_app_msg[invalid_email_msg]['.$language.'][content]" class="help-block error">:message</label>')!!}
													</div>
												</div>
									       </div>
								   </div>
								   ...
								   <div class="row">
										 <div class="col-md-12">
									        	<div class="form-group{{ $errors->has('power_meter_mobile_app_msg[no_room_register_msg]['.$language.']') ? ' has-error' : '' }}">
													...
													<div class="col-md-12">
														{!! Form::text('power_meter_mobile_app_msg[no_room_register_msg]['.$language.'][title]', (isset($no_room_register_msg[$language]->title) ? $no_room_register_msg[$language]->title : null), ['class'=>'form-control','placeholder'=>'Title']) !!}
														{!!$errors->first('power_meter_mobile_app_msg[no_room_register_msg]['.$language.'][title]', '<label for="power_meter_mobile_app_msg[no_room_register_msg]['.$language.'][title]" class="help-block error">:message</label>')!!}
													</div>
													<div class="col-md-12">
														{!! Form::textarea('power_meter_mobile_app_msg[no_room_register_msg]['.$language.'][content]', (isset($no_room_register_msg[$language]->content) ? $no_room_register_msg[$language]->content : null), ['id'=>'power_meter_mobile_app_msg[no_room_register_msg]['.$language.'][content]', 'rows'=>'10' , 'cols'=>'80','class'=>'form-control tinymce']) !!}
									                    {!!$errors->first('power_meter_mobile_app_msg[no_room_register_msg]['.$language.'][content]', '<label for="power_meter_mobile_app_msg[no_room_register_msg]['.$language.'][content]" class="help-block error">:message</label>')!!}
													</div>
												</div>
									       </div>
								   </div>
								   ...
								   <div class="row">
										 <div class="col-md-12">
									        	<div class="form-group{{ $errors->has('power_meter_mobile_app_msg[system_maintenance_msg]['.$language.']') ? ' has-error' : '' }}">
													...
													<div class="col-md-12">
														{!! Form::text('power_meter_mobile_app_msg[system_maintenance_msg]['.$language.'][title]', (isset($system_maintenance_msg[$language]->title) ? $system_maintenance_msg[$language]->title : null), ['class'=>'form-control','placeholder'=>'Title']) !!}
														{!!$errors->first('power_meter_mobile_app_msg[system_maintenance_msg]['.$language.'][title]', '<label for="power_meter_mobile_app_msg[system_maintenance_msg]['.$language.'][title]" class="help-block error">:message</label>')!!}
													</div>
													<div class="col-md-12">
														{!! Form::textarea('power_meter_mobile_app_msg[system_maintenance_msg]['.$language.'][content]', (isset($system_maintenance_msg[$language]->content) ? $system_maintenance_msg[$language]->content : null), ['id'=>'power_meter_mobile_app_msg[system_maintenance_msg]['.$language.'][content]', 'rows'=>'10' , 'cols'=>'80','class'=>'form-control tinymce']) !!}
									                    {!!$errors->first('power_meter_mobile_app_msg[system_maintenance_msg]['.$language.'][content]', '<label for="power_meter_mobile_app_msg[system_maintenance_msg]['.$language.'][content]" class="help-block error">:message</label>')!!}
													</div>
												</div>
									       </div>
								   </div>
								   ...
								   <div class="row">
										 <div class="col-md-12">
									        	<div class="form-group{{ $errors->has('power_meter_mobile_app_msg[no_allow_payment_msg]['.$language.']') ? ' has-error' : '' }}">
													...
													<div class="col-md-12">
														{!! Form::text('power_meter_mobile_app_msg[no_allow_payment_msg]['.$language.'][title]', (isset($no_allow_payment_msg[$language]->title) ? $no_allow_payment_msg[$language]->title : null), ['class'=>'form-control','placeholder'=>'Title']) !!}
														{!!$errors->first('power_meter_mobile_app_msg[no_allow_payment_msg]['.$language.'][title]', '<label for="power_meter_mobile_app_msg[no_allow_payment_msg]['.$language.'][title]" class="help-block error">:message</label>')!!}
													</div>
													<div class="col-md-12">
														{!! Form::textarea('power_meter_mobile_app_msg[no_allow_payment_msg]['.$language.'][content]', (isset($no_allow_payment_msg[$language]->content) ? $no_allow_payment_msg[$language]->content : null), ['id'=>'power_meter_mobile_app_msg[no_allow_payment_msg]['.$language.'][content]', 'rows'=>'10' , 'cols'=>'80','class'=>'form-control tinymce']) !!}
									                    {!!$errors->first('power_meter_mobile_app_msg[no_allow_payment_msg]['.$language.'][content]', '<label for="power_meter_mobile_app_msg[no_allow_payment_msg]['.$language.'][content]" class="help-block error">:message</label>')!!}
													</div>
												</div>
									       </div>
								   </div>
								   ...
								   <div class="row">
										 <div class="col-md-12">
									        	<div class="form-group{{ $errors->has('power_meter_mobile_app_msg[no_access_right]['.$language.']') ? ' has-error' : '' }}">
													...
													<div class="col-md-12">
														{!! Form::text('power_meter_mobile_app_msg[no_access_right]['.$language.'][title]', (isset($no_access_right[$language]->title) ? $no_access_right[$language]->title : null), ['class'=>'form-control','placeholder'=>'Title']) !!}
														{!!$errors->first('power_meter_mobile_app_msg[no_access_right]['.$language.'][title]', '<label for="power_meter_mobile_app_msg[no_access_right]['.$language.'][title]" class="help-block error">:message</label>')!!}
													</div>
													<div class="col-md-12">
														{!! Form::textarea('power_meter_mobile_app_msg[no_access_right]['.$language.'][content]', (isset($no_access_right[$language]->content) ? $no_access_right[$language]->content : null), ['id'=>'power_meter_mobile_app_msg[no_access_right]['.$language.'][content]', 'rows'=>'10' , 'cols'=>'80','class'=>'form-control tinymce']) !!}
									                    {!!$errors->first('power_meter_mobile_app_msg[no_access_right]['.$language.'][content]', '<label for="power_meter_mobile_app_msg[no_access_right]['.$language.'][content]" class="help-block error">:message</label>')!!}
													</div>
												</div>
									       </div>
								   </div>

								   <h6 class="hk-sec-title mt-15">{{App\Language::trans('Email Notification Template')}}</h6> <hr>	

								   <div class="row">
										 <div class="col-md-12">
									        	<div class="form-group{{ $errors->has('power_meter_payment_success_email['.$language.']') ? ' has-error' : '' }}">
													...
													<div class="col-md-12">
														{!! Form::text('power_meter_payment_success_email['.$language.'][title]', (isset($power_meter_payment_success_email[$language]->title) ? $power_meter_payment_success_email[$language]->title : null), ['class'=>'form-control','placeholder'=>'Title']) !!}
														{!!$errors->first('power_meter_payment_success_email['.$language.'][title]', '<label for="power_meter_payment_success_email['.$language.'][title]" class="help-block error">:message</label>')!!}
													</div>
													<div class="col-md-12">
														{!! Form::textarea('power_meter_payment_success_email['.$language.'][content]', (isset($power_meter_payment_success_email[$language]->content) ? $power_meter_payment_success_email[$language]->content : null), ['id'=>'power_meter_payment_success_email['.$language.'][content]', 'rows'=>'10' , 'cols'=>'80','class'=>'form-control tinymce']) !!}
									                    {!!$errors->first('power_meter_payment_success_email['.$language.'][content]', '<label for="power_meter_payment_success_email['.$language.'][content]" class="help-block error">:message</label>')!!}
													</div>
												</div>
									       </div>
								   </div>
								   ...
								   <div class="row">
										 <div class="col-md-12">
									        	<div class="form-group{{ $errors->has('power_meter_low_credit_reminder['.$language.']') ? ' has-error' : '' }}">
													...
													<div class="col-md-12">
														{!! Form::text('power_meter_low_credit_reminder['.$language.'][title]', (isset($power_meter_low_credit_reminder[$language]->title) ? $power_meter_low_credit_reminder[$language]->title : null), ['class'=>'form-control','placeholder'=>'Title']) !!}
														{!!$errors->first('power_meter_low_credit_reminder['.$language.'][title]', '<label for="power_meter_low_credit_reminder['.$language.'][title]" class="help-block error">:message</label>')!!}
													</div>
													<div class="col-md-12">
														{!! Form::textarea('power_meter_low_credit_reminder['.$language.'][content]', (isset($power_meter_low_credit_reminder[$language]->content) ? $power_meter_low_credit_reminder[$language]->content : null), ['id'=>'power_meter_low_credit_reminder['.$language.'][content]', 'rows'=>'10' , 'cols'=>'80','class'=>'form-control tinymce']) !!}
									                    {!!$errors->first('power_meter_low_credit_reminder['.$language.'][content]', '<label for="power_meter_low_credit_reminder['.$language.'][content]" class="help-block error">:message</label>')!!}
													</div>
												</div>
									       </div>
								   </div>
								    ...
								    <div class="row">
										 <div class="col-md-12">
									        	<div class="form-group{{ $errors->has('power_meter_payment_reminder_email['.$language.']') ? ' has-error' : '' }}">
													...
													<div class="col-md-12">
														{!! Form::text('power_meter_payment_reminder_email['.$language.'][title]', (isset($power_meter_payment_reminder_email[$language]->title) ? $power_meter_payment_reminder_email[$language]->title : null), ['class'=>'form-control','placeholder'=>'Title']) !!}
														{!!$errors->first('power_meter_payment_reminder_email['.$language.'][title]', '<label for="power_meter_payment_reminder_email['.$language.'][title]" class="help-block error">:message</label>')!!}
													</div>
													<div class="col-md-12">
														{!! Form::textarea('power_meter_payment_reminder_email['.$language.'][content]', (isset($power_meter_payment_reminder_email[$language]->content) ? $power_meter_payment_reminder_email[$language]->content : null), ['id'=>'power_meter_payment_reminder_email['.$language.'][content]', 'rows'=>'10' , 'cols'=>'80','class'=>'form-control tinymce']) !!}
									                    {!!$errors->first('power_meter_payment_reminder_email['.$language.'][content]', '<label for="power_meter_payment_reminder_email['.$language.'][content]" class="help-block error">:message</label>')!!}
													</div>
												</div>
									       </div>
								   </div>
								   ...
								   <div class="row">
										 <div class="col-md-12">
									        	<div class="form-group{{ $errors->has('power_meter_turn_off_meter_email['.$language.']') ? ' has-error' : '' }}">
													...
													<div class="col-md-12">
														{!! Form::text('power_meter_turn_off_meter_email['.$language.'][title]', (isset($power_meter_turn_off_meter_email[$language]->title) ? $power_meter_turn_off_meter_email[$language]->title : null), ['class'=>'form-control','placeholder'=>'Title']) !!}
														{!!$errors->first('power_meter_turn_off_meter_email['.$language.'][title]', '<label for="power_meter_turn_off_meter_email['.$language.'][title]" class="help-block error">:message</label>')!!}
													</div>
													<div class="col-md-12">
														{!! Form::textarea('power_meter_turn_off_meter_email['.$language.'][content]', (isset($power_meter_turn_off_meter_email[$language]->content) ? $power_meter_turn_off_meter_email[$language]->content : null), ['id'=>'power_meter_turn_off_meter_email['.$language.'][content]', 'rows'=>'10' , 'cols'=>'80','class'=>'form-control tinymce']) !!}
									                    {!!$errors->first('power_meter_turn_off_meter_email['.$language.'][content]', '<label for="power_meter_turn_off_meter_email['.$language.'][content]" class="help-block error">:message</label>')!!}
													</div>
												</div>
									       </div>
								   </div>
								     ...
								     <div class="row">
										 <div class="col-md-12">
									        	<div class="form-group{{ $errors->has('power_meter_power_supply_restore_email['.$language.']') ? ' has-error' : '' }}">
													...
													<div class="col-md-12">
														{!! Form::text('power_meter_power_supply_restore_email['.$language.'][title]', (isset($power_meter_power_supply_restore_email[$language]->title) ? $power_meter_power_supply_restore_email[$language]->title : null), ['class'=>'form-control','placeholder'=>'Title']) !!}
														{!!$errors->first('power_meter_power_supply_restore_email['.$language.'][title]', '<label for="power_meter_power_supply_restore_email['.$language.'][title]" class="help-block error">:message</label>')!!}
													</div>
													<div class="col-md-12">
														{!! Form::textarea('power_meter_power_supply_restore_email['.$language.'][content]', (isset($power_meter_power_supply_restore_email[$language]->content) ? $power_meter_power_supply_restore_email[$language]->content : null), ['id'=>'power_meter_power_supply_restore_email['.$language.'][content]', 'rows'=>'10' , 'cols'=>'80','class'=>'form-control tinymce']) !!}
									                    {!!$errors->first('power_meter_power_supply_restore_email['.$language.'][content]', '<label for="power_meter_power_supply_restore_email['.$language.'][content]" class="help-block error">:message</label>')!!}
													</div>
												</div>
									       </div>
								   </div>
	 ...
	 <div role="tabpanel" class="tab-pane" id="pm_admin_operational_setting">
	    		<!-- <h6 class="hk-sec-title mt-15">{{App\Language::trans('Operational Setting')}}</h6> <hr>	 -->
			...
			<div class="row">
					<div class="col-md-6">
						<div class="form-group{{ $errors->has('is_auto_on_off_on') ? ' has-error' : '' }}">
							{!! Form::label('is_auto_on_off_on', App\Language::trans('Auto On Off Module'), ['class'=>'control-label col-md-12']) !!}
							<div class="col-md-12">
								 <div class="row">	
								 	<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input onchange="init_auto_on_off_section();" type="radio"   value=1 {{isset($model->is_auto_on_off) == true ? ($model->is_auto_on_off == true ? 'checked' : '') : 'checked'}} id="is_auto_on_off_on" name="is_auto_on_off"  class="custom-control-input">
									        <label class="custom-control-label" for="is_auto_on_off_on">{{App\Language::trans('On')}}</label>
									    </div>
									</div>
									<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input onchange="init_auto_on_off_section();" type="radio" value=0 {{isset($model->is_auto_on_off) == true ? ($model->is_auto_on_off == false ? 'checked' : '') : ''}} id="is_auto_on_off_off" name="is_auto_on_off"  class="custom-control-input">
									        <label class="custom-control-label" for="is_auto_on_off_off">{{App\Language::trans('Off')}}</label>
									    </div>
									</div>
								 </div>
								 {!!$errors->first('is_auto_on_off_on', '<label for="is_auto_on_off_on" class="help-block error">:message</label>')!!}
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row" id='auto_module_div1'>
				<div class="col-md-12">
					<div class="form-group{{ $errors->has('power_meter_operational_setting[remote_relay_api_url]') ? ' has-error' : '' }}">
						{!! Form::label('remote_relay_api_url', App\Language::trans('Remote Relay Control API URL'), ['class'=>'control-label col-md-12']) !!}
						<div class="col-md-12">
							{!! Form::text('power_meter_operational_setting[remote_relay_api_url]', (isset($model->id) ? (isset($power_meter_operational_setting['remote_relay_api_url']) ? $power_meter_operational_setting['remote_relay_api_url'] : '') : 0), ['class'=>'form-control','min'=>'1','max'=>'999999','autofocus']) !!}
			                {!!$errors->first('power_meter_operational_setting[remote_relay_api_url]', '<label for="power_meter_operational_setting[remote_relay_api_url]" class="help-block error">:message</label>')!!}
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row" id='auto_module_div2'>
				<div class="col-md-12">
					<div class="form-group{{ $errors->has('power_meter_operational_setting[remote_relay_program_api_url]') ? ' has-error' : '' }}">
						...
						<div class="col-md-12">
							{!! Form::text('power_meter_operational_setting[remote_relay_program_api_url]', (isset($model->id) ? (isset($power_meter_operational_setting['remote_relay_program_api_url']) ? $power_meter_operational_setting['remote_relay_program_api_url'] : '') : 0), ['class'=>'form-control','min'=>'1','max'=>'999999','autofocus']) !!}
			                {!!$errors->first('power_meter_operational_setting[remote_relay_program_api_url]', '<label for="power_meter_operational_setting[remote_relay_program_api_url]" class="help-block error">:message</label>')!!}
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group{{ $errors->has('power_meter_operational_setting[no_reading_alert_percent]') ? ' has-error' : '' }}">
						...
						<div class="col-md-12">
							{!! Form::number('power_meter_operational_setting[no_reading_alert_percent]', (isset($model->id) ? (isset($power_meter_operational_setting['warning_email_interval']) ? $power_meter_operational_setting['warning_email_interval'] : '') : 0), ['class'=>'form-control','min'=>'1','max'=>'999999','autofocus']) !!}
			                {!!$errors->first('power_meter_operational_setting[no_reading_alert_percent]', '<label for="power_meter_operational_setting[no_reading_alert_percent]" class="help-block error">:message</label>')!!}
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
				        <div class="form-group {!!$errors->first('code') ? 'has-error' : ''!!}">
				          <label for="code" class="control-label col-sm-2">{{App\Language::trans('Notification List')}}</label>
					          <div class="col-sm-12">
			...
			<div class="row">
				...
				<div class="col-md-12">
						<div class="form-group{{ $errors->has('server_available_check_period_mins') ? ' has-error' : '' }}">
							...
							<div class="col-md-12">
							{!! Form::number('power_meter_operational_setting[server_available_check_period_mins]', (isset($model->id) ? (isset($power_meter_operational_setting['warning_email_interval']) ? $power_meter_operational_setting['warning_email_interval'] : '') : 0), ['class'=>'form-control','min'=>'5','max'=>'999999','autofocus']) !!}
			                {!!$errors->first('power_meter_operational_setting[server_available_check_period_mins]', '<label for="power_meter_operational_setting[server_available_check_period_mins]" class="help-block error">:message</label>')!!}
						</div>
						</div>
					</div>
				...
				<div class="col-md-12">
				        <div class="form-group {!!$errors->first('code') ? 'has-error' : ''!!}">
				          <label for="code" class="control-label col-sm-12">{{App\Language::trans('Remote Server Break Down Notification List')}}</label>
					          <div class="col-sm-12">
			...
			<ul class="nav nav-light nav-tabs bo" role="tablist">
				...
				@foreach($language_listing as $language)
					...
					<li role="presentation" class="nav-item">
						<a href="#{{ $language }}_operational" aria-controls="{{ $language }}_operational" class="d-flex align-items-center nav-link{{ $tab_status }} fs-16 zero-padding" role="tab" data-toggle="tab"><h5>{{App\Language::trans(ucfirst($language))}}</h5></a>
					</li>
					@php $tab_status =''; @endphp
				@endforeach
			...
			<div class="tab-content">			
					@foreach($language_listing as $language)
					    <div role="tabpanel" class="tab-pane{{ $tab_status }}" id="{{ $language }}_operational">
					    		<h6 class="hk-sec-title mt-15">{{App\Language::trans('Mobile Apps Message Setting')}}</h6> <hr>	
					    	    <div class="row">
										 <div class="col-md-12">
									        	<div class="form-group{{ $errors->has('power_meter_mobile_app_msg[no_reading_notification_email]['.$language.']') ? ' has-error' : '' }}">
													...
													<div class="col-md-12">
														{!! Form::textarea('power_meter_mobile_app_msg[no_reading_notification_email]['.$language.']', (isset($no_reading_notification_email[$language]) ? $no_reading_notification_email[$language] : null), ['id'=>'power_meter_mobile_app_msg[no_reading_notification_email]['.$language.']', 'rows'=>'10' , 'cols'=>'80','class'=>'form-control tinymce']) !!}
									                    {!!$errors->first('power_meter_mobile_app_msg[no_reading_notification_email]['.$language.']', '<label for="power_meter_mobile_app_msg[no_reading_notification_email]['.$language.']" class="help-block error">:message</label>')!!}
													</div>
												</div>
									       </div>
								   </div>
		 ...
		 <div role="tabpanel" class="tab-pane" id="pm_uat_setting">
		 			...
		 			<div class="row">
								...
								<div class="form-group{{ $errors->has('power_meter_operational_setting[is_auto_turn_off_meter]') ? ' has-error' : '' }}">
									...
									<div class="col-md-12">
										 <div class="row">	
										 	<div class="col-md-3">
											    <div class="custom-control custom-radio">
											        <input type="radio" value=1 {{isset($power_meter_operational_setting['is_in_uat']) == true ? ($power_meter_operational_setting['is_in_uat'] == true ? 'checked' : '') : 'checked'}}  value=1 id="power_meter_operational_setting[is_in_uat]_on" name="power_meter_operational_setting[is_in_uat]" checked class="custom-control-input">
											        <label class="custom-control-label" for="power_meter_operational_setting[is_in_uat]_on">{{App\Language::trans('Yes')}}</label>
											    </div>
											</div>
											<div class="col-md-3">
											    <div class="custom-control custom-radio">
											        <input type="radio" value=0 {{isset($power_meter_operational_setting['is_in_uat']) == true ? ($power_meter_operational_setting['is_in_uat'] == false ? 'checked' : '') : ''}} id="power_meter_operational_setting[is_in_uat]_off" name="power_meter_operational_setting[is_in_uat]"  class="custom-control-input">
											        <label class="custom-control-label" for="power_meter_operational_setting[is_in_uat]_off">{{App\Language::trans('No')}}</label>
											    </div>
											</div>
										 </div>
										 {!!$errors->first('power_meter_operational_setting[is_in_uat]', '<label for="power_meter_operational_setting[is_in_uat]" class="help-block error">:message</label>')!!}
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6">
			                		<div class="form-group{{ $errors->has('power_meter_operational_setting[testing_payment_gateway]') ? ' has-error' : '' }}">
			                            ...
			                            <div class="col-md-8">
			                            	{!! Form::select('power_meter_operational_setting[testing_payment_gateway]', App\Setting::payment_gateway_combobox(), isset($power_meter_operational_setting['testing_payment_gateway']) ? $power_meter_operational_setting['testing_payment_gateway'] : null, ['class'=>'form-control','required']) !!}
			                            	{!!$errors->first('power_meter_operational_setting[testing_payment_gateway]', '<label for="power_meter_operational_setting[testing_payment_gateway]" class="help-block error">:message</label>')!!}
			                        	</div>
			                        </div>
			                </div>
			            </div>
					...
					@endphp
				 	<div class="row">
						<div class="col-md-12">
						        <div class="form-group {!!$errors->first('code') ? 'has-error' : ''!!}">
						          <label for="code" class="control-label col-sm-2">{{App\Language::trans('UAT Tester')}}</label>
							          <div class="col-sm-12">
		 ...
		 <div role="tabpanel" class="tab-pane" id="pm_onoff_setting">
			...
			<div class="row">
				<div class="col-md-12">
						<div class="form-group {!!$errors->first('code') ? 'has-error' : ''!!}">
							<label for="code" class="control-label col-sm-2">{{App\Language::trans('Exclude List')}}</label>
								<div class="col-sm-12">
 ...
 -->
						...
						<div class="form-group{{ $errors->has('is_period_item_to_monthly_break_down') ? ' has-error' : '' }}">
							...
							<div class="col-md-12">
								 <div class="row">	
								 	<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=1 {{isset($model->is_period_item_to_monthly_break_down) == true ? ($model->is_period_item_to_monthly_break_down == true ? 'checked' : '') : 'checked'}}  value=1 id="is_period_item_to_monthly_break_downon" name="is_pay_by_accumulate" checked class="custom-control-input">
									        <label class="custom-control-label" for="is_period_item_to_monthly_break_downon">{{App\Language::trans('Per Item')}}</label>
									    </div>
									</div>
									<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=0 {{isset($model->is_period_item_to_monthly_break_down) == true ? ($model->is_period_item_to_monthly_break_down == false ? 'checked' : '') : ''}} id="is_period_item_to_monthly_break_downoff" name="is_pay_by_accumulate"  class="custom-control-input">
						...
						<div class="form-group{{ $errors->has('is_direct_allow_to_payment') ? ' has-error' : '' }}">
							...
							<div class="col-md-12">
								 <div class="row">	
								 	<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=1 {{isset($model->is_direct_allow_to_payment) == true ? ($model->is_direct_allow_to_payment == true ? 'checked' : '') : 'checked'}}  value=1 id="is_direct_allow_to_payment_on" name="is_direct_allow_to_payment" checked class="custom-control-input">
									        <label class="custom-control-label" for="is_direct_allow_to_payment_on">{{App\Language::trans('Enabled')}}</label>
									    </div>
									</div>
									<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=0 {{isset($model->is_direct_allow_to_payment) == true ? ($model->is_direct_allow_to_payment == false ? 'checked' : '') : ''}}  value=1 {{isset($model->is_direct_allow_to_payment) == true ? ($model->is_direct_allow_to_payment == true ? 'checked' : '') : 'checked'}}  id="is_direct_allow_to_payment_off" name="is_direct_allow_to_payment"  class="custom-control-input">
			...
			<div class="row">
				<div class="col-md-6">
                		<div class="form-group{{ $errors->has('bank_account') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                            	{!! Form::select('bank_account', App\Setting::bank_or_cash_combobox(), null, ['class'=>'form-control']) !!}
		...
		<div role="tabpanel" class="tab-pane" id="leaf_accounting">		
			<h6 class="hk-sec-title">{{App\Language::trans('API Setting')}}</h6> <hr>
	    	 <div class="row">
					<div class="col-md-6">
						<div class="form-group{{ $errors->has('is_on_accounting_api') ? ' has-error' : '' }}">
							{!! Form::label('is_on_accounting_api', App\Language::trans('Status'), ['class'=>'control-label col-md-12']) !!}
							<div class="col-md-12">
								 <div class="row">	
								 	<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=1 {{isset($model->is_on_accounting_api) == true ? ($model->is_on_accounting_api == true ? 'checked' : '') : 'checked'}}  value=1 id="is_on_accounting_api_on" name="is_on_accounting_api" checked class="custom-control-input">
									        <label class="custom-control-label" for="is_on_accounting_api_on">{{App\Language::trans('Enabled')}}</label>
									    </div>
									</div>
									<div class="col-md-3">
									    <div class="custom-control custom-radio">
									        <input type="radio" value=0 {{isset($model->is_on_accounting_api) == true ? ($model->is_on_accounting_api == false ? 'checked' : '') : ''}}  id="is_on_accounting_api_off" name="is_on_accounting_api"  class="custom-control-input">
									        <label class="custom-control-label" for="is_on_accounting_api_off">{{App\Language::trans('Disabled')}}</label>
									    </div>
									</div>
								 </div>
								 {!!$errors->first('is_on_accounting_api', '<label for="is_on_accounting_api" class="help-block error">:message</label>')!!}
							</div>
						</div>
					</div>	
				</div>
