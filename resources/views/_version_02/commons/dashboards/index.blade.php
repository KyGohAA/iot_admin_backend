...
@if(App\Company::is_allow_to_access_module(App\Setting::LABEL_MODULE_POWER_MANAGEMENT))
	<div class="hk-row">
		...
		<div class="col-lg-3 col-sm-6">
			...
			<div class="card card-sm">				
				<div class="card-body">
					...
					<span class="d-block font-11 font-weight-500 text-dark text-uppercase mb-10">{{App\Language::trans('Credit Below').' '.$company->getCurrenncyCode().' '.$company->getPMOperationalSetting()->credit_threshold}}</span>
					<div class="d-flex align-items-center justify-content-between position-relative">
						<div>
							<span class="d-block">
		...
		<div class="col-lg-3 col-sm-6">
			...
			<div class="card card-sm">
				<div class="card-body">
					<span class="d-block font-11 font-weight-500 text-dark text-uppercase mb-10">{{App\Language::trans('Healthy credit').' ( > '.' '.$company->getCurrenncyCode().' '.$company->getPMOperationalSetting()->credit_threshold.' )' }}</span>
					...
					<div class="card">
						<div class="card-header card-header-action">
							...
							<div class="d-flex align-items-center card-action-wrap">
								<span style=" text-transform: none; align:left;">{{App\Language::trans('Last contact at :')}} {{$company['system_alive_at'] }}</span>
								...
								@endphp
								<span style="margin-left:20px;" class="btn btn-sm btn-{{$alive_status}}">{{App\Language::trans('')}} {{ $lost_contact_period_mins }}</span>
							</div>
						</div>
					</div>	
				</div>
