...
<head>
    ...
    <title><?php echo e(isset($page_variable['page_title']) ? $page_variable['page_title'] : (isset($page_title) ? $page_title : "")); ?></title>
...
<body>
        ...
        <div class="hk-pg-wrapper hk-auth-wrapper">
            <header class="d-flex justify-content-between align-items-center">
                <a class="d-flex auth-brand" href="#">
                    <img style="width:100px;height: :60px;" class="brand-img" src="<?php echo e(isset($company['system_logo_path']) ? asset($company['system_logo_path']) : asset('_app_icon.png')); ?>" alt="brand" />
                </a>
                <div class="btn-group btn-group-sm">
                    <!-- <a href="#" class="btn btn-outline-secondary">Help</a> -->
                    <?php if(isset($company['system_logo_path'])): ?>
                ...
                <div class="row">
                    <div class="col-xl-5 pa-0">
                        <div id="owl_demo_1" class="owl-carousel dots-on-item owl-theme">
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url(<?php echo e(asset('img/opencarts/login/login_2.jpg')); ?>);">
                            ...
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url(<?php echo e(asset('img/opencarts/login/login_3.jpg')); ?>);">
                                <div class="auth-cover-info py-xl-0 pt-100 pb-50">
                                    <div class="auth-cover-content text-center w-xxl-75 w-sm-90 w-xs-100">
                    ...
                    <div class="col-xl-7 pa-0">
                        <div class="auth-form-wrap py-xl-0 py-50">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                <?php echo Form::model($model, ['class'=>'form-signin']); ?>
                                    ...
                                    <div class="form-group">
                                        <?php echo Form::email('user_email', null, ['class'=>'form-control','placeholder'=>App\Language::trans('Email Address'),'required','autofocus' ,'type'=> 'email']); ?>

                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <?php echo Form::password('user_password', ['class'=>'form-control','placeholder'=>App\Language::trans('Password'),'required']); ?>
                                    ...
                                    <div class="custom-control custom-checkbox mb-25">
                                        ...
                                        <?php echo Form::label('remember_me', App\Language::trans('Remember me'), ['class'=>'custom-control-label font-14']); ?>
    ...
    <script src="<?php echo e(asset('version_2/dist/js/login-data.js')); ?>"></script>
