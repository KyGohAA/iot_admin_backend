<div id="left-sidebar" class="sidebar">
        <div class="sidebar-scroll">
            <div class="user-account">
                <img style="margin-top:7px;" src="<?php echo e(Auth::user()->profile_jpg()); ?>" class="rounded-circle user-photo" alt="User Profile Picture">
                <div class="dropdown">
                    <span>Welcome,</span>
                    <a href="javascript:void(0);" class="user-name" data-toggle="dropdown"><strong><?php echo e(Auth::user()->fullname); ?></strong></a>
                    
                    <!-- <a href="javascript:void(0);" class="dropdown-toggle user-name" data-toggle="dropdown"><strong><?php echo e(Auth::user()->fullname); ?></strong></a>
                ...
                <hr>
                        <div class="row">
                            <button style="width:90%;margin-left:5%;" class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Project</button>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="javascript:void(0);">Leaf-Office</a>
                                <a class="dropdown-item" href="javascript:void(0);">Project01</a>
                            </div>
                        </div>
                ...
                <div class="tab-pane active" id="admin">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active"><a href="<?php echo e(action('IOTUniversalsController@getDashboard')); ?>"><i class="icon-home"></i><span>Dashboard</span></a></li>
                            <li><a href="<?php echo e(action('IOTUniversalsController@getIndex', ['user'])); ?>"><i class="icon-users"></i> <span>Users</span></a></li>
                            
                             <li><a href="<?php echo e(action('IOTUniversalsController@getIndex', ['network_server'])); ?>"><i class="icon-control-pause"></i> <span>Network Server</span></a></li>
                             <li><a href="<?php echo e(action('IOTUniversalsController@getIndex', ['gateway'])); ?>"><i class="icon-notebook"></i> <span>Gateways</span></a></li>
                             <li><a href="<?php echo e(action('IOTUniversalsController@getIndex', ['application'])); ?>"><i class="icon-list"></i> <span>Applications</span></a></li>
                             <li><a href="<?php echo e(action('IOTUniversalsController@getIndex', ['device'])); ?>"><i class="icon-share fa-rotate-90 d-inline-block"></i> <span>Devices</span></a></li>
