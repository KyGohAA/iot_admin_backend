...
<?php echo $__env->make('_version_02.billings.ar_payment_receiveds.partials._hidden_variable', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('_version_02.billings.ar_payment_receiveds.partials._add_new_member_modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<div>
    <?php echo Form::model($model, ['class'=>'form-horizontal','id'=>'membership-application-form']); ?>
            ...
            <div class="col-xl-4 mb-20">
                <div class="card mt-10">
                    <div class="card-body bg-light">
                        <?php echo Form::select('product_id', App\Product::membership_combobox(), isset($leaf_product_id) ? $leaf_product_id : null , ['class'=>'form-control','onchange'=>'init_membership_info_by_leaf_product_id(this, "sales")']); ?>

                        <!-- <h5 class="card-title"><label id="lbl_product_name"><?php echo e($model['name']); ?></label></h5> -->
                        <div class="form-group<?php echo e($errors->has('product_id') ? ' has-error' : ''); ?>">
                            <div class="col-md-8">
                               <!--  <?php echo Form::select('product_id', App\Product::leaf_all_payable_item_combobox(), null, ['class'=>'form-control card-title','onchange'=>'init_state_selectbox(this)']); ?> -->
                                <?php echo $errors->first('product_id', '<label for="product_id" class="help-block efrror">:message</label>'); ?>

                            </div>
                        </div>
                        <p class="card-text">Annual fee : RM <label id="lbl_product_amount"><?php echo e($model['amount']); ?></label></h5></p>                    
                    </div>
                </div>
            ...
            <div class="col-xl-8 mb-20">    
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input class="form-control" id="username" placeholder="Username" type="text" value="<?php echo e($customer['name']); ?>">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="email">Email</label>
                        <input class="form-control" id="email" placeholder="you@example.com" type="email" value="<?php echo e($customer['email']); ?>">
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0" id="membership_item_table">
                            <tbody>
                                ...
                                <?php if(isset($membership['id'])): ?>
                                    <?php $__currentLoopData = $membership->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr id=<?php echo e($member['id_house_member']); ?>>
                                            <td><img class="w-80p" src="<?php echo e($member["profile_photo"] == "" ?  asset('img/img-thumb.jpg')  : $member["house_member_photo"]); ?>" alt="icon" /></td>
                                            <th scope="row"><?php echo e($member['name']); ?></th>
                                            <td><?php echo e($member['ic']); ?></td>
                                            <td class="text-dark"><?php echo e($member['email']); ?></td>
                                            <td>
                                                <label class="alert alert-success alert-wth-icon alert-dismissible fade show" role="alert" onclick="create_or_update_member_modal(<?php echo e($member['id_house_member']); ?>);">
                                                    <span class="alert-icon-wrap"><i class="zmdi zmdi-edit"></i></span> Edit
                                                </label>
                                            </td>
                                            <td>
                                                <button type="button" class="close" aria-label="Edit" onclick="remove_row_membership_application(<?php echo e($member['id_house_member']); ?> , 'membership_item_table');">
                                ...
                                ?>    
                                <?php for($i=0 ; $i < $remaining_slot ; $i++ ): ?>

                                    <tr id=<?php echo e($i."_new_member"); ?>>
                                            <td colspan="6" class="text-center"> 
                                ...
                                <table class="table table-sm mb-0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <th class="w-30" scope="row" id="member_sub_total"><?php echo e($model['amount']); ?></th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tfoot>
                                        <tr class="bg-light">
                                            ...
                                            <th class="text-dark font-18" scope="row" id="member_payable_amount"><?php echo e($model['amount']); ?></th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm mb-0">
                            <tbody>
                                <tr>
                                    <th class="w-70" scope="row">Sub Total</th>
                                    <th class="w-30" scope="row" id="summary_sub_total"><?php echo e($model['amount']); ?></th>
                                </tr> 
                                <tr>
                                    <td class="w-70">Tax</td>
                                    <td class="w-30">-</td>
                            ...
                            <tfoot>
                                <tr class="bg-light">
                                    ...
                                    <th class="text-dark font-18" scope="row" id="summary_total"><?php echo e($model['amount']); ?></th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
