						...
						<tr>
							...
							<?php $__currentLoopData = $row->toArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php if($key == 'complaint'): ?>
									<td class="text-center"><?php echo e($row->display_substr($value)); ?></td>
								<?php elseif($key != 'id'): ?>
									<td class="text-center"><?php echo e($value); ?></td>
								<?php endif; ?>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<td class="text-center">
								<!-- <a onclick="return confirm(confirmMsg)" class="loading-label" href="<?php echo e(action('InternalTicketsController@getEdit', [$row->id])); ?>"><?php echo e(App\Language::trans('Edit')); ?></a> | 
								<a href="<?php echo e(action('InternalTicketsController@getView', [$row->id])); ?>"><?php echo e(App\Language::trans('View')); ?></a> |  -->
								<a class="loading-label" href="<?php echo e(action('InternalTicketsController@getSolve', [$row->id])); ?>"><?php echo e(App\Language::trans('Feedback')); ?></a> | 
								<a onclick="return confirm(confirmMsg)" class="loading-label" href="<?php echo e(action('InternalTicketsController@getDelete', [$row->id])); ?>"><?php echo e(App\Language::trans('Del')); ?></a>
							</td>
						</tr>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
