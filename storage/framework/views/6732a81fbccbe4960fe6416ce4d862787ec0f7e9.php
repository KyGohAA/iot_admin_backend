                ...
                <table id="leaf_data_table" class="table tablesaw table-bordered table-hover mb-0 w-100 pb-30">
                    <thead>
                        <tr>
							...
							<?php else: ?>
								<th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0"><?php echo e(App\Language::trans(ucwords(str_replace('_', ' ', $col)))); ?></th>
							<?php endif; ?>
                         ...
                         <?php $__currentLoopData = $model; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="<?php echo e($row['id']); ?>">   
								...
								<td class="text-center">
									<a onclick="return confirm(confirmMsg)" class="loading-label" href="<?php echo e(action('UserGroupsController@getEdit', [$row->id])); ?>"><?php echo e(App\Language::trans('Edit')); ?></a> | 
									<a class="loading-label" href="<?php echo e(action('UserGroupsController@getView', [$row->id])); ?>"><?php echo e(App\Language::trans('View')); ?></a> | 
									<a onclick="return confirm(confirmMsg)" class="loading-label" href="<?php echo e(action('UserGroupsController@getDelete', [$row->id])); ?>"><?php echo e(App\Language::trans('Del')); ?></a>
								</td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
