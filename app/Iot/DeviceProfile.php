...
class DeviceProfile extends ExtendModel
{
    //protected $primaryKey = 'device_profile_id';
    ...
    */
    ...
    public static function getById($device_profile_id)
    {
        return DeviceProfile::where('device_profile_id','=',$device_profile_id)
                    ->first();
    }
    ...
    */
    ...
    public function validate_form($input)
    {
        $rules = [
                    'state_id'  =>  'required',
                    'code'      =>  'required|unique:device_profile,code,NULL,id,leaf_group_id,'.Company::get_group_id(),
                    'name'      =>  'required|unique:device_profile,name,NULL,id,leaf_group_id,'.Company::get_group_id(),
                    ];

        if ($this->id) {
            $rules['code'] = 'required|unique:device_profile,code,'.$this->id.',id,leaf_group_id,'.Company::get_group_id();
            $rules['name'] = 'required|unique:device_profile,name,'.$this->id.',id,leaf_group_id,'.Company::get_group_id();
        }
