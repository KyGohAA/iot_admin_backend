...
class DeviceReading extends ExtendModel
{
    protected $table = 'device_reading';
    public $timestamps = true;
    protected $listing_except_columns = ['created_by','updated_by'];
    ...
    */
    ...
    public static function getByDeviceEui($dev_eui)
    {
        return static::where('dev_eui','=',$dev_eui)->get();
    }
    ...
    */
    ...
    public function validate_form($input)
    {
        $rules = [
                    'state_id'  =>  'required',
                    'code'      =>  'required|unique:cities,code,NULL,id,leaf_group_id,'.Company::get_group_id(),
                    'name'      =>  'required|unique:cities,name,NULL,id,leaf_group_id,'.Company::get_group_id(),
                    ];

        if ($this->id) {
            $rules['code'] = 'required|unique:cities,code,'.$this->id.',id,leaf_group_id,'.Company::get_group_id();
            $rules['name'] = 'required|unique:cities,name,'.$this->id.',id,leaf_group_id,'.Company::get_group_id();
        }
