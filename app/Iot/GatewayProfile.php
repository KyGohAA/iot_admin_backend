...
class GatewayProfile extends ExtendModel
{
    protected $primaryKey = 'gateway_profile_id';
    protected $table = 'gateway_profile';
    ...
    */
    ...
    public function validate_form($input)
    {
        $rules = [
                    'state_id'  =>  'required',
                    'code'      =>  'required|unique:gateway_profile,code,NULL,id,leaf_group_id,'.Company::get_group_id(),
                    'name'      =>  'required|unique:gateway_profile,name,NULL,id,leaf_group_id,'.Company::get_group_id(),
                    ];

        if ($this->id) {
            $rules['code'] = 'required|unique:gateway_profile,code,'.$this->id.',id,leaf_group_id,'.Company::get_group_id();
            $rules['name'] = 'required|unique:gateway_profile,name,'.$this->id.',id,leaf_group_id,'.Company::get_group_id();
        }
