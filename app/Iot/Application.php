...
class Application extends ExtendModel
{
...
mqtt_tls_cert*/
    ...
    */
    ...
    {
        return $this->belongsTo('App\ServiceProfile', 'service_profile_id');
    }
    ...
    */
    ...
    public function validate_form($input)
    {
        $rules = [
                    'state_id'  =>  'required',
                    'code'      =>  'required|unique:application,code,NULL,id,leaf_group_id,'.Company::get_group_id(),
                    'name'      =>  'required|unique:application,name,NULL,id,leaf_group_id,'.Company::get_group_id(),
                    ];

        if ($this->id) {
            $rules['code'] = 'required|unique:application,code,'.$this->id.',id,leaf_group_id,'.Company::get_group_id();
            $rules['name'] = 'required|unique:application,name,'.$this->id.',id,leaf_group_id,'.Company::get_group_id();
        }
