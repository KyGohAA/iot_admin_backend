...
class AirbnbWebGrabber /*extends DOMXpath*/ {

	const domain = "https://www.airbnb.com/";
	...
	{
		return static::domain.static::dashboard_url;
	...
	public static function get_dashobord_content(){

		$url = static::get_dashboard_url();
		$url = 'https://www.airbnb.com/z/q/816199245';
		//$url = 'https://www.airbnb.com/night-at/guinnessstorehouse';
		$url = 'https://www.airbnb.com/s/all';
