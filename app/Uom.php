...
class Uom extends ExtendModel
{
    ...
    */
    ...
    {
        $rules = [
                    'code'      =>  'required|unique:uoms,code,NULL,id,leaf_group_id,'.Company::get_group_id(),
                    'name'      =>  'required|unique:uoms,name,NULL,id,leaf_group_id,'.Company::get_group_id(),
                    ];

        if ($this->id) {
            $rules['code'] = 'required|unique:uoms,code,'.$this->id.',id,leaf_group_id,'.Company::get_group_id();
            $rules['name'] = 'required|unique:uoms,name,'.$this->id.',id,leaf_group_id,'.Company::get_group_id();
        }
