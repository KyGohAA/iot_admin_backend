...
class MeterClass extends ExtendModel
{
    protected $table = 'meter_classes';
    ...
    */
    ...
    {
        $rules = [
                    'name'      =>  'required|unique:meter_classes,name,NULL,id,leaf_group_id,'.Company::get_group_id(),
                    ];

        if ($this->id) {
            $rules['name'] = 'required|unique:meter_classes,name,'.$this->id.',id,leaf_group_id,'.Company::get_group_id();
        }
